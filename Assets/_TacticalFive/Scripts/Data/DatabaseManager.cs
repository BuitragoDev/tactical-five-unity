...
public class DatabaseManager : MonoBehaviour
{
    ...
    void SeedPlayers()
    {
        ...
        Add(3, "ATL", "Aaron", "Wiggins", "SF", 27, "USA", 198, 93, 80, 82, 92, 88, 86, 80, 84, 88, 71, 90, 88, 84, 29, 9000000, 3, false);
        Add(7, "ATL", "Jonathan", "Kuminga", "SF", 22, "COD", 201, 99, 78, 88, 95, 83, 72, 72, 78, 80, 78, 97, 81, 72, 50, 24000000, 1, false);
        Add(8, "ATL", "Buddy", "Hield", "SG", 33, "BAH", 196, 97, 73, 70, 86, 96, 94, 74, 76, 68, 59, 74, 80, 63, 33, 9000000, 2, false);
        Add(10, "ATL", "Corey", "Kispert", "SF", 27, "USA", 201, 97, 68, 68, 78, 80, 80, 65, 67, 68, 63, 69, 70, 65, 43, 13000000, 3, false);
        Add(11, "ATL", "Asa", "Newell", "PF", 20, "USA", 208, 100, 66, 80, 79, 61, 44, 57, 53, 73, 81, 89, 73, 59, 57, 3600000, 3, false);
        Add(12, "ATL", "Jock", "Landale", "C", 29, "AUS", 211, 109, 66, 63, 71, 65, 43, 67, 53, 67, 84, 74, 80, 57, 65, 13200000, 1, false);
        Add(16, "ATL", "Kingston", "Flemings", "PG", 19, "USA", 191, 88, 72, 85, 90, 78, 70, 82, 84, 78, 60, 92, 80, 86, 48, 6100000, 4, true);
        Add(17, "ATL", "Zuby", "Ejiofor", "PF", 21, "NGA", 203, 104, 63, 76, 80, 64, 54, 66, 68, 82, 88, 88, 72, 68, 78, 3800000, 4, true);
        Add(18, "ATL", "Henri", "Veesaar", "C", 22, "EST", 213, 104, 61, 76, 74, 70, 76, 68, 66, 78, 84, 76, 80, 66, 70, 2000000, 2, true);

        // ── BOS ──
        Add(19, "BOS", "Jayson", "Tatum", "PF", 28, "USA", 203, 95, 94, 96, 99, 99, 99, 99, 99, 99, 96, 99, 99, 90, 67, 54100000, 4, false);
        Add(362, "BOS", "Paul", "George", "SF", 36, "USA", 206, 100, 88, 88, 96, 98, 98, 87, 93, 99, 73, 98, 96, 99, 31, 35000000, 2, false);
        ...
        Add(283, "BKN", "Julius", "Randle", "PF", 31, "USA", 203, 113, 86, 86, 95, 97, 84, 87, 91, 89, 91, 95, 95, 72, 50, 33000000, 3, false);
        Add(37, "BKN", "Nic", "Claxton", "C", 27, "USA", 211, 98, 84, 86, 94, 78, 51, 76, 68, 98, 99, 98, 92, 72, 98, 25300000, 3, false);
        Add(90, "BKN", "Keon", "Ellis", "SG", 27, "USA", 193, 79, 82, 82, 92, 85, 83, 79, 85, 94, 69, 90, 88, 94, 43, 9000000, 3, false);
        ...
        Add(354, "BKN", "Moritz", "Wagner", "C", 29, "GER", 211, 111, 80, 80, 83, 92, 87, 81, 85, 79, 88, 81, 88, 63, 53, 12000000, 2, false);
        ...
        Add(287, "CHA", "Naz", "Reid", "C", 27, "USA", 206, 113, 82, 88, 86, 93, 89, 80, 84, 84, 89, 86, 87, 66, 58, 16000000, 4, false);
        Add(379, "CHA", "Grayson", "Allen", "SG", 30, "USA", 193, 90, 82, 82, 93, 97, 99, 87, 93, 83, 61, 85, 93, 85, 26, 15000000, 2, false);
        Add(380, "CHA", "Royce", "O'Neale", "SF", 32, "USA", 198, 104, 80, 80, 85, 83, 87, 83, 87, 92, 71, 91, 87, 89, 25, 11000000, 2, false);
        ...
        Add(253, "CHI", "Norman", "Powell", "SG", 33, "USA", 193, 97, 82, 82, 96, 98, 94, 82, 92, 79, 67, 94, 94, 73, 33, 22500000, 2, false);
        ...
        // ── DAL ──
        Add(101, "DAL", "Kyrie", "Irving", "PG", 34, "USA", 188, 88, 90, 90, 99, 99, 99, 99, 99, 86, 70, 99, 99, 95, 46, 36500000, 2, false);
        Add(102, "DAL", "Cooper", "Flagg", "SF", 19, "USA", 206, 92, 87, 98, 88, 88, 84, 86, 90, 94, 84, 95, 92, 82, 74, 13800000, 4, false);
        Add(103, "DAL", "P.J.", "Washington", "PF", 27, "USA", 201, 104, 84, 84, 88, 90, 86, 82, 86, 92, 86, 92, 90, 78, 54, 14100000, 2, false);
        Add(238, "DAL", "Santi", "Aldama", "PF", 25, "ESP", 211, 98, 80, 85, 84, 87, 89, 80, 84, 82, 82, 85, 87, 68, 52, 12000000, 4, false);
        ...
        Add(110, "DAL", "Khris", "Middleton", "SF", 34, "USA", 201, 100, 81, 81, 79, 94, 94, 91, 92, 81, 75, 81, 96, 69, 39, 33200000, 1, false);
        Add(112, "DAL", "Tyler", "Smith", "PF", 21, "USA", 206, 101, 75, 88, 82, 79, 77, 69, 73, 79, 79, 88, 79, 67, 53, 1900000, 3, false);
        Add(113, "DAL", "Ryan", "Nembhard", "PG", 23, "CAN", 180, 81, 76, 82, 96, 79, 75, 98, 94, 67, 53, 80, 90, 77, 27, 400000, 4, false);
        Add(114, "DAL", "Brandon", "Williams", "PG", 26, "USA", 188, 86, 74, 76, 95, 82, 76, 87, 85, 68, 54, 85, 82, 72, 28, 2200000, 1, false);
        Add(116, "DAL", "Morez", "Johnson Jr.", "PF", 19, "USA", 206, 104, 71, 84, 84, 66, 52, 70, 74, 82, 90, 93, 76, 68, 82, 5700000, 4, true);
        Add(117, "DAL", "Sergio", "de Larrea", "SF", 20, "ESP", 203, 91, 63, 77, 78, 74, 78, 76, 78, 80, 62, 78, 82, 68, 48, 3600000, 4, true);
        Add(118, "DAL", "Tobi", "Lawal", "PF", 21, "NGA", 203, 102, 57, 70, 84, 62, 50, 64, 66, 78, 80, 90, 68, 68, 72, 2000000, 2, true);
        Add(119, "DAL", "Vsevolod", "Ishchenko", "SG", 21, "RUS", 193, 84, 57, 68, 78, 74, 72, 76, 74, 70, 50, 76, 76, 66, 36, 2000000, 2, true);
        ...
        Add(115, "DEN", "Marvin", "Bagley III", "PF", 27, "USA", 208, 106, 76, 76, 89, 87, 56, 72, 74, 85, 95, 91, 83, 56, 48, 4000000, 1, false);
        Add(125, "DEN", "Tyus", "Jones", "PG", 30, "USA", 185, 89, 81, 81, 90, 88, 82, 99, 98, 77, 61, 82, 99, 88, 27, 8000000, 1, false);
        ...
        Add(135, "DEN", "Bryce", "Hopkins", "PF", 23, "USA", 203, 100, 57, 67, 76, 68, 66, 70, 72, 76, 72, 78, 74, 68, 56, 2000000, 2, true);
        Add(136, "DEN", "Trevon", "Brazile", "PF", 23, "USA", 206, 97, 60, 72, 82, 66, 60, 70, 72, 80, 76, 84, 72, 70, 62, 2000000, 2, true);
        ...
        Add(202, "DET", "John", "Collins", "PF", 29, "USA", 206, 103, 84, 84, 92, 94, 83, 79, 87, 87, 93, 98, 91, 69, 51, 17000000, 3, false);
        Add(139, "DET", "Ausar", "Thompson", "SF", 23, "USA", 201, 98, 84, 92, 93, 78, 66, 82, 85, 97, 80, 99, 87, 95, 62, 10000000, 3, false);
        Add(335, "DET", "Isaiah", "Joe", "SG", 27, "USA", 193, 88, 80, 80, 92, 98, 99, 86, 92, 76, 60, 82, 94, 74, 27, 8000000, 2, false);
        ...
        Add(151, "DET", "Ebuka", "Okorie", "PG", 20, "NGA", 185, 84, 65, 78, 90, 78, 72, 82, 84, 76, 52, 88, 78, 80, 38, 4400000, 4, true);
        Add(152, "DET", "Ugonna", "Onyenso", "C", 21, "NGA", 213, 107, 57, 70, 70, 54, 36, 58, 58, 76, 94, 78, 70, 60, 92, 2000000, 2, true);
        ...
        Add(155, "GSW", "Kristaps", "Porzingis", "C", 31, "LAT", 221, 109, 86, 86, 84, 95, 91, 82, 76, 92, 90, 88, 95, 60, 93, 20000000, 2, false);
        ...
        Add(159, "GSW", "De'Anthony", "Melton", "SG", 28, "USA", 188, 91, 79, 79, 91, 81, 77, 81, 83, 93, 67, 87, 85, 91, 33, 5500000, 2, false);
        ...
        Add(166, "GSW", "Yaxel", "Lendeborg", "PF", 22, "VEN", 206, 100, 70, 81, 82, 70, 74, 78, 80, 91, 87, 85, 82, 78, 74, 5300000, 4, true);
        Add(167, "GSW", "Lajae", "Jones", "SF", 22, "USA", 201, 97, 57, 67, 78, 70, 68, 68, 72, 74, 64, 80, 70, 68, 52, 2000000, 2, true);

        // ── HOU ──
        Add(168, "HOU", "Kevin", "Durant", "SF", 38, "USA", 211, 109, 93, 93, 96, 99, 99, 99, 99, 94, 88, 99, 99, 78, 62, 54700000, 2, false);
        Add(221, "HOU", "Marcus", "Smart", "PG", 32, "USA", 193, 100, 81, 81, 85, 81, 75, 90, 86, 98, 65, 86, 94, 98, 33, 7500000, 2, false);
        ...
        Add(205, "HOU", "Bogdan", "Bogdanovic", "SG", 34, "SRB", 196, 102, 80, 80, 87, 94, 98, 89, 93, 75, 63, 85, 96, 69, 31, 16000000, 1, false);
        ...
        Add(183, "HOU", "Bruce", "Thornton", "PG", 22, "USA", 191, 97, 62, 72, 83, 82, 80, 82, 80, 76, 52, 82, 82, 74, 38, 2200000, 2, true);
        ...
        Add(363, "IND", "Kelly", "Oubre Jr.", "SF", 30, "USA", 198, 95, 80, 82, 93, 89, 86, 80, 84, 89, 66, 89, 87, 87, 30, 8500000, 2, false);
        ...
        Add(198, "IND", "Braden", "Smith", "PG", 22, "USA", 185, 84, 59, 70, 82, 76, 74, 86, 82, 76, 50, 78, 88, 74, 36, 2000000, 2, true);

        // ── LAC ──    
        Add(200, "LAC", "Darius", "Garland", "PG", 26, "USA", 185, 87, 89, 91, 99, 99, 99, 99, 99, 86, 70, 99, 99, 92, 38, 40000000, 4, false);
        Add(437, "LAC", "Brandon", "Ingram", "SF", 28, "USA", 206, 98, 88, 90, 99, 99, 99, 92, 96, 86, 68, 98, 99, 88, 44, 38000000, 4, false);
        Add(441, "LAC", "Gradey", "Dick", "SG", 23, "USA", 198, 90, 82, 86, 96, 99, 99, 86, 92, 78, 60, 88, 96, 76, 32, 8000000, 4, false);
        ...
        Add(213, "LAC", "Keaton", "Wagler", "PG", 19, "USA", 196, 86, 76, 89, 88, 84, 86, 88, 84, 87, 60, 83, 92, 76, 40, 8400000, 4, true);
        Add(214, "LAC", "Baba", "Miller", "SF", 22, "ESP", 203, 100, 59, 71, 80, 66, 62, 68, 70, 80, 74, 82, 72, 70, 60, 2000000, 2, true);
        Add(215, "LAC", "Nick", "Martinelli", "SF", 22, "USA", 203, 97, 58, 68, 76, 76, 78, 70, 74, 76, 64, 76, 78, 66, 48, 2000000, 2, true);
        Add(216, "LAC", "Narcisse", "Ngoy", "SF", 21, "FRA", 206, 97, 56, 70, 76, 64, 62, 66, 68, 74, 70, 80, 70, 64, 58, 2000000, 2, true);

        // ── LAL ──
        Add(217, "LAL", "Luka", "Doncic", "PG", 27, "SLO", 201, 104, 95, 97, 99, 99, 99, 99, 99, 89, 79, 89, 99, 99, 77, 55000000, 5, false);
        Add(454, "LAL", "Walker", "Kessler", "C", 25, "USA", 213, 118, 84, 80, 76, 85, 44, 72, 76, 99, 99, 99, 99, 76, 99, 32500000, 4, false);
        Add(364, "LAL", "Quentin", "Grimes", "SG", 26, "USA", 196, 92, 82, 84, 93, 93, 93, 82, 88, 88, 66, 90, 91, 88, 30, 15000000, 4, false);
        Add(72, "LAL", "Collin", "Sexton", "PG", 27, "USA", 188, 86, 84, 84, 99, 99, 89, 91, 99, 79, 61, 98, 95, 81, 33, 9500000, 2, false);
        Add(447, "LAL", "Sandro", "Mamukelashvili", "PF", 27, "GEO", 208, 104, 78, 80, 82, 88, 84, 80, 84, 86, 80, 84, 86, 78, 26, 10000000, 4, false);
        Add(219, "LAL", "Austin", "Reaves", "SG", 28, "USA", 196, 89, 86, 88, 96, 99, 96, 99, 99, 82, 71, 92, 99, 78, 35, 46250000, 4, false);
        ...
        Add(232, "LAL", "Cameron", "Carr", "SG", 21, "USA", 196, 93, 63, 78, 86, 82, 84, 72, 76, 74, 60, 86, 74, 68, 44, 3700000, 4, true);

        // ── MEM ──
        Add(392, "MEM", "Jerami", "Grant", "PF", 32, "USA", 206, 102, 84, 84, 93, 93, 90, 86, 90, 93, 78, 91, 91, 89, 30, 28000000, 3, false);
        Add(401, "MEM", "Kris", "Murray", "SF", 25, "USA", 203, 98, 76, 84, 85, 83, 79, 77, 81, 87, 69, 85, 83, 81, 26, 3000000, 3, false);
        ...
        Add(143, "MEM", "Isaiah", "Stewart", "PF", 25, "USA", 203, 113, 79, 80, 77, 81, 77, 72, 73, 89, 89, 87, 83, 73, 68, 15000000, 3, false);
        ...
        Add(249, "MEM", "Richie", "Saunders", "SG", 24, "USA", 196, 95, 61, 73, 80, 84, 86, 74, 74, 74, 58, 76, 76, 68, 40, 2000000, 2, true);
        ...
        Add(261, "MIA", "Ryan", "Conwell", "SG", 20, "USA", 193, 86, 59, 71, 82, 78, 72, 72, 74, 72, 54, 82, 74, 70, 40, 2000000, 2, true);
        Add(132, "MIA", "Tim", "Hardaway Jr.", "SG", 34, "USA", 196, 93, 77, 77, 89, 94, 98, 75, 83, 75, 63, 83, 87, 67, 33, 6500000, 1, false);
        ...
        Add(281, "MIL", "Malique", "Lewis", "SF", 23, "TTO", 201, 95, 55, 64, 76, 66, 68, 66, 68, 72, 60, 76, 68, 66, 46, 2000000, 2, true);

        // ── MIN ──
        Add(282, "MIN", "Anthony", "Edwards", "SG", 25, "USA", 193, 102, 95, 97, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 66, 58000000, 5, false);
        Add(54, "MIN", "LaMelo", "Ball", "PG", 25, "USA", 201, 82, 89, 92, 99, 99, 99, 99, 99, 85, 70, 99, 99, 89, 42, 37900000, 4, false);
        ...
        Add(295, "MIN", "Trey", "Kaufman-Renn", "PF", 22, "USA", 206, 109, 57, 65, 72, 66, 52, 66, 66, 76, 84, 76, 78, 64, 72, 2000000, 2, true);
        Add(296, "MIN", "Isaiah", "Evans", "SG", 19, "USA", 198, 91, 61, 76, 84, 80, 76, 74, 76, 74, 60, 84, 74, 70, 46, 2000000, 2, true);
        ...
        Add(312, "NOP", "Jaron", "Pierre Jr.", "PG", 22, "USA", 191, 86, 57, 66, 82, 78, 72, 78, 76, 72, 50, 80, 76, 72, 40, 2000000, 2, true);
        ...
        Add(327, "NYK", "Tyler", "Nickel", "SF", 21, "USA", 203, 97, 57, 68, 76, 72, 76, 70, 74, 76, 66, 78, 76, 68, 50, 2000000, 2, true);
        Add(328, "NYK", "Jack", "Kayil", "PG", 20, "GER", 191, 84, 58, 70, 80, 72, 70, 80, 78, 72, 50, 78, 80, 68, 36, 2000000, 2, true);
        ...
        Add(343, "OKC", "Aday", "Mara", "C", 20, "ESP", 221, 109, 68, 82, 72, 64, 66, 65, 60, 78, 95, 80, 80, 62, 90, 5000000, 4, true);
        Add(344, "OKC", "Bennett", "Stirtz", "PG", 22, "USA", 191, 86, 67, 75, 84, 82, 80, 82, 80, 80, 55, 80, 86, 76, 38, 4500000, 4, true);
        Add(345, "OKC", "Otega", "Oweh", "SG", 22, "USA", 196, 97, 59, 70, 86, 76, 64, 72, 74, 82, 58, 86, 70, 82, 48, 2000000, 2, true);

        // ── ORL ──
        Add(346, "ORL", "Paolo", "Banchero", "PF", 26, "USA", 208, 113, 92, 94, 99, 99, 93, 95, 98, 96, 94, 99, 99, 79, 61, 48000000, 5, false);
        Add(24, "ORL", "Nikola", "Vucevic", "C", 35, "MNE", 208, 120, 83, 83, 71, 95, 87, 91, 81, 85, 98, 83, 98, 59, 65, 3900000, 1, false);
        ...
        Add(359, "ORL", "Izaiyah", "Nelson", "PF", 22, "USA", 206, 104, 56, 67, 74, 58, 46, 62, 62, 76, 84, 82, 70, 66, 76, 2000000, 2, true);
        ...
        Add(20, "PHI", "Jaylen", "Brown", "SG", 29, "USA", 198, 101, 90, 91, 99, 99, 94, 90, 98, 99, 89, 99, 99, 89, 57, 53100000, 4, false);
        Add(98, "PHI", "Dean", "Wade", "PF", 30, "USA", 206, 103, 76, 76, 78, 81, 85, 72, 74, 85, 77, 79, 83, 70, 52, 9750000, 4, false);
        ...
        Add(374, "PHI", "Labaron", "Philon Jr.", "PG", 20, "USA", 191, 86, 64, 77, 86, 80, 74, 80, 82, 74, 52, 84, 80, 74, 38, 3900000, 4, true);
        ...
        Add(56, "PHX", "Miles", "Bridges", "PF", 28, "USA", 201, 102, 84, 84, 92, 92, 84, 83, 90, 88, 83, 98, 90, 75, 49, 25000000, 2, false);
        Add(381, "PHX", "Ryan", "Dunn", "SF", 23, "USA", 203, 98, 78, 88, 90, 80, 74, 76, 80, 92, 70, 94, 86, 90, 26, 5000000, 4, false);
        Add(231, "PHX", "Luke", "Kennard", "SG", 30, "USA", 196, 93, 76, 76, 87, 90, 99, 83, 88, 69, 59, 81, 90, 61, 29, 7500000, 2, false);
        ...
        Add(512, "PHX", "Pat", "Spencer", "SG", 29, "USA", 196, 95, 74, 80, 82, 76, 78, 78, 80, 72, 50, 78, 76, 78, 8, 1500000, 1, false);
        Add(387, "PHX", "Koa", "Peat", "SF", 19, "USA", 201, 102, 62, 74, 84, 68, 66, 68, 70, 80, 74, 86, 72, 72, 58, 3400000, 4, true);

        // ── POR ──
        Add(233, "POR", "Ja", "Morant", "PG", 27, "USA", 188, 79, 91, 93, 99, 99, 99, 99, 99, 93, 79, 99, 99, 98, 49, 44000000, 4, false);
        ...
        Add(396, "POR", "Robert", "Williams III", "C", 28, "USA", 208, 108, 82, 82, 86, 82, 41, 70, 69, 99, 99, 98, 94, 65, 99, 14600000, 3, false);
        ...
        Add(416, "SAC", "Alex", "Karaban", "SF", 22, "USA", 206, 100, 63, 73, 76, 74, 78, 70, 74, 82, 72, 76, 84, 70, 56, 3400000, 4, true);
        Add(417, "SAC", "Darius", "Acuff Jr.", "PG", 19, "USA", 191, 88, 74, 87, 89, 88, 80, 85, 86, 76, 55, 88, 80, 78, 44, 6700000, 4, true);
        Add(418, "SAS", "Maliq", "Brown", "SF", 22, "USA", 201, 95, 58, 69, 80, 64, 56, 66, 70, 84, 70, 84, 70, 84, 56, 2000000, 2, true);
        Add(419, "SAC", "Emanuel", "Sharp", "SG", 22, "USA", 191, 86, 58, 68, 78, 80, 84, 72, 74, 80, 54, 76, 74, 78, 38, 2000000, 2, true);
        ...
        Add(140, "SAS", "Tobias", "Harris", "PF", 34, "USA", 203, 102, 80, 80, 78, 89, 88, 84, 86, 84, 84, 82, 93, 68, 44, 15500000, 2, false);
        Add(425, "SAS", "Keldon", "Johnson", "SF", 26, "USA", 198, 100, 82, 84, 94, 94, 88, 84, 88, 86, 71, 90, 92, 84, 31, 18000000, 3, false);
        Add(426, "SAS", "Harrison", "Barnes", "SF", 34, "USA", 203, 102, 80, 80, 86, 89, 87, 84, 87, 88, 72, 88, 88, 86, 25, 8000000, 1, false);
        ...
        Add(433, "SAS", "Jayden", "Quaintance", "PF", 19, "USA", 206, 104, 65, 79, 82, 62, 54, 66, 68, 84, 90, 90, 74, 70, 82, 4100000, 4, true);
        Add(434, "SAS", "Tarris", "Reed Jr.", "C", 22, "USA", 206, 113, 64, 74, 72, 64, 44, 64, 60, 78, 92, 82, 78, 66, 82, 3600000, 4, true);
        Add(435, "SAS", "Ja'Kobi", "Gillespie", "PG", 22, "USA", 191, 88, 59, 70, 84, 80, 68, 80, 78, 80, 52, 82, 78, 82, 44, 2000000, 2, true);

        // ── TOR ──
        Add(199, "TOR", "Kawhi", "Leonard", "SF", 35, "USA", 201, 102, 92, 92, 89, 99, 92, 94, 99, 99, 85, 94, 99, 96, 55, 50000000, 2, false);
        ...
        Add(578, "TOR", "Alijah", "Martin", "SG", 22, "USA", 193, 88, 76, 84, 84, 76, 74, 74, 76, 74, 52, 76, 74, 74, 10, 2300000, 2, false);
        Add(450, "TOR", "Allen", "Graves", "SF", 22, "USA", 203, 100, 65, 76, 80, 72, 72, 74, 76, 84, 74, 80, 80, 74, 56, 4200000, 4, true);
        Add(451, "TOR", "Jaden", "Bradley", "PG", 22, "USA", 188, 84, 57, 66, 82, 76, 70, 80, 76, 78, 52, 80, 78, 76, 40, 2000000, 2, true);
        ...
        Add(455, "UTA", "Jusuf", "Nurkic", "C", 31, "BIH", 213, 127, 82, 78, 69, 85, 52, 77, 81, 93, 97, 93, 95, 63, 97, 11000000, 2, false);
        ...
        Add(466, "UTA", "Darryn", "Peterson", "SG", 19, "USA", 196, 98, 80, 94, 91, 91, 88, 84, 92, 85, 66, 93, 85, 80, 55, 10500000, 4, true);

        // ── WAS ──
        Add(467, "WAS", "Trae", "Young", "PG", 27, "USA", 185, 82, 94, 94, 99, 99, 99, 99, 99, 96, 78, 99, 99, 99, 68, 53000000, 4, false);
        ...
        Add(482, "WAS", "AJ", "Dybantsa", "SF", 19, "USA", 206, 95, 82, 95, 93, 88, 78, 82, 90, 82, 72, 97, 83, 75, 52, 13500000, 4, true);
        Add(483, "WAS", "Felix", "Okpara", "C", 22, "NGA", 213, 107, 58, 70, 72, 56, 38, 60, 56, 76, 92, 78, 72, 64, 88, 2000000, 2, true);
    ...
    public void SeedFreeAgents()
    {
        ...
        // ── Free Agents ──
        AddFA(218, "LeBron", "James", "SF", 42, "USA", 206, 113, 89, 89, 92, 99, 91, 99, 99, 91, 93, 97, 99, 82, 48, 52600000, 1);
        AddFA(9, "Gabe", "Vincent", "PG", 29, "USA", 193, 88, 69, 67, 84, 74, 68, 74, 72, 78, 60, 70, 76, 70, 33, 11000000, 2);
        AddFA(13, "Caleb", "Houstan", "SF", 23, "CAN", 201, 97, 66, 74, 79, 71, 73, 62, 64, 66, 62, 69, 67, 67, 46, 2000000, 3);
        AddFA(14, "Keaton", "Wallace", "SG", 25, "USA", 191, 93, 62, 62, 80, 67, 61, 63, 65, 65, 49, 73, 65, 63, 31, 2300000, 2);
        AddFA(15, "Christian", "Koloko", "C", 25, "CMR", 213, 104, 60, 68, 73, 52, 34, 52, 46, 63, 73, 73, 61, 54, 79, 2000000, 2);
