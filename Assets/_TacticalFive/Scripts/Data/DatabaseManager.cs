...
public class DatabaseManager : MonoBehaviour
{
    ...
    void SeedPlayers()
    {
        ...
        // ── ATL ──
        Add(1, "ATL", "Jalen", "Johnson", "SF", 24, "USA", 203, 99, 86, 91, 92, 85, 83, 92, 88, 88, 93, 98, 92, 80, 55, 30_000_000, 5, false);
        Add(2, "ATL", "Nickeil", "Alexander-Walker", "SG", 27, "CAN", 196, 90, 81, 82, 95, 86, 78, 80, 84, 88, 72, 86, 84, 88, 50, 15_500_000, 4, false);
        Add(3, "ATL", "Dyson", "Daniels", "SG", 22, "AUS", 196, 93, 79, 86, 95, 75, 66, 82, 80, 93, 70, 85, 82, 99, 42, 7_700_000, 2, false);
        Add(4, "ATL", "Onyeka", "Okongwu", "C", 25, "USA", 206, 104, 80, 84, 88, 72, 50, 71, 64, 91, 99, 97, 89, 70, 89, 15_000_000, 4, false);
        Add(5, "ATL", "Zaccharie", "Risacher", "SF", 21, "FRA", 203, 90, 76, 84, 85, 87, 89, 81, 85, 75, 63, 77, 87, 73, 34, 13_200_000, 4, false);
        Add(6, "ATL", "CJ", "McCollum", "SG", 34, "USA", 191, 86, 78, 74, 90, 94, 88, 85, 92, 75, 57, 77, 88, 71, 41, 22_000_000, 2, false);
        Add(7, "ATL", "Jonathan", "Kuminga", "SF", 22, "COD", 201, 99, 78, 88, 95, 83, 72, 72, 78, 80, 78, 97, 81, 72, 50, 7_000_000, 2, false);
        Add(8, "ATL", "Buddy", "Hield", "SG", 33, "BAH", 196, 97, 73, 70, 86, 96, 94, 74, 76, 68, 59, 74, 80, 63, 33, 19_000_000, 2, false);
        Add(9, "ATL", "Gabe", "Vincent", "PG", 29, "USA", 193, 88, 69, 67, 84, 74, 68, 74, 72, 78, 60, 70, 76, 70, 33, 11_000_000, 2, false);
        Add(10, "ATL", "Corey", "Kispert", "SF", 27, "USA", 201, 97, 68, 68, 78, 80, 80, 65, 67, 68, 63, 69, 70, 65, 43, 14_000_000, 3, false);
        Add(11, "ATL", "Asa", "Newell", "PF", 20, "USA", 208, 100, 66, 80, 79, 61, 44, 57, 53, 73, 81, 89, 73, 59, 57, 3_600_000, 4, false);
        Add(12, "ATL", "Jock", "Landale", "C", 29, "AUS", 211, 109, 66, 63, 71, 65, 43, 67, 53, 67, 84, 74, 80, 57, 65, 3_200_000, 2, false);
        Add(13, "ATL", "Caleb", "Houstan", "SF", 23, "CAN", 201, 97, 66, 74, 79, 71, 73, 62, 64, 66, 62, 69, 67, 67, 46, 2_000_000, 3, false);
        Add(14, "ATL", "Keaton", "Wallace", "SG", 25, "USA", 191, 93, 62, 62, 80, 67, 61, 63, 65, 65, 49, 73, 65, 63, 31, 2_300_000, 2, false);
        Add(15, "ATL", "Christian", "Koloko", "C", 25, "CMR", 213, 104, 60, 68, 73, 52, 34, 52, 46, 63, 73, 73, 61, 54, 79, 2_000_000, 2, false);
        Add(16, "ATL", "Kingston", "Flemings", "PG", 19, "USA", 191, 88, 72, 85, 90, 78, 70, 82, 84, 78, 60, 92, 80, 86, 48, 6_100_000, 4, true);
        Add(17, "ATL", "Zuby", "Ejiofor", "PF", 21, "NGA", 203, 104, 63, 76, 80, 64, 54, 66, 68, 82, 88, 88, 72, 68, 78, 3_800_000, 4, true);
        Add(18, "ATL", "Henri", "Veesaar", "C", 22, "EST", 213, 104, 61, 76, 74, 70, 76, 68, 66, 78, 84, 76, 80, 66, 70, 2_000_000, 2, true);

        // ── BOS ──
        Add(19, "BOS", "Jayson", "Tatum", "PF", 28, "USA", 203, 95, 94, 96, 99, 99, 99, 99, 99, 99, 96, 99, 99, 90, 67, 54100000, 4, false);
        Add(20, "BOS", "Jaylen", "Brown", "SG", 29, "USA", 198, 101, 90, 91, 99, 99, 94, 90, 98, 99, 89, 99, 99, 89, 57, 53100000, 4, false);
        ...
        Add(24, "BOS", "Nikola", "Vucevic", "C", 35, "MNE", 208, 120, 83, 83, 71, 95, 87, 91, 81, 85, 98, 83, 98, 59, 65, 21400000, 1, false);
        ...
        Add(27, "BOS", "Baylor", "Scheierman", "SG", 25, "USA", 198, 92, 75, 82, 86, 84, 90, 78, 80, 75, 67, 77, 82, 69, 37, 2600000, 2, false);
        Add(28, "BOS", "Dalano", "Banton", "PG", 26, "CAN", 203, 92, 76, 78, 90, 82, 75, 81, 84, 79, 67, 83, 81, 73, 41, 2500000, 1, false);
        Add(29, "BOS", "Hugo", "Gonzalez", "SF", 20, "ESP", 198, 91, 72, 84, 86, 74, 68, 68, 74, 78, 66, 86, 76, 74, 42, 2200000, 4, false);
        Add(30, "BOS", "Luka", "Garza", "C", 27, "USA", 208, 110, 74, 74, 69, 91, 73, 75, 69, 73, 96, 75, 87, 49, 57, 2300000, 1, false);
        Add(31, "BOS", "Amari", "Williams", "C", 24, "GBR", 211, 113, 71, 79, 71, 65, 52, 67, 59, 77, 89, 85, 77, 58, 81, 1200000, 4, false);
        Add(32, "BOS", "Max", "Shulga", "PG", 24, "UKR", 193, 88, 69, 76, 82, 75, 78, 77, 79, 67, 57, 73, 77, 63, 31, 1200000, 4, false);
        Add(33, "BOS", "Ron", "Harper Jr.", "SF", 26, "USA", 198, 111, 70, 73, 80, 74, 76, 66, 70, 76, 66, 80, 76, 66, 40, 1200000, 2, false);
        Add(34, "BOS", "Chris", "Cenac Jr.", "PF", 21, "USA", 208, 102, 63, 75, 76, 66, 66, 68, 70, 80, 82, 80, 78, 68, 68, 3_500_000, 4, true);
        Add(35, "BOS", "Dillon", "Mitchell", "SF", 22, "USA", 203, 93, 59, 72, 86, 62, 40, 68, 72, 86, 72, 92, 68, 78, 58, 2_000_000, 2, true);

        // ── BKN ──
        Add(36, "BKN", "Michael", "Porter Jr.", "SF", 28, "USA", 208, 99, 86, 86, 93, 99, 99, 82, 91, 86, 88, 89, 95, 64, 60, 38300000, 2, false);
        Add(37, "BKN", "Nic", "Claxton", "C", 27, "USA", 211, 98, 84, 86, 94, 78, 51, 76, 68, 98, 99, 98, 92, 72, 98, 25300000, 3, false);
        Add(38, "BKN", "Terance", "Mann", "SG", 29, "USA", 196, 98, 79, 79, 88, 83, 73, 83, 85, 87, 71, 88, 87, 81, 43, 15500000, 2, false);
        Add(39, "BKN", "Noah", "Clowney", "PF", 22, "USA", 208, 95, 78, 86, 85, 79, 75, 71, 75, 83, 81, 91, 81, 73, 64, 3400000, 2, false);
        Add(40, "BKN", "Ziaire", "Williams", "SF", 24, "USA", 206, 84, 77, 82, 90, 82, 78, 74, 80, 82, 72, 86, 82, 72, 49, 6250000, 1, false);
        Add(41, "BKN", "Egor", "Demin", "PG", 19, "RUS", 203, 91, 79, 92, 90, 82, 80, 94, 92, 74, 68, 88, 88, 72, 41, 6900000, 4, false);
        Add(42, "BKN", "Nolan", "Traore", "PG", 19, "FRA", 191, 84, 77, 91, 98, 80, 70, 95, 92, 70, 60, 90, 86, 74, 32, 3810000, 4, false);
        ...
        Add(49, "BKN", "Josh", "Minott", "SF", 23, "USA", 203, 98, 75, 82, 90, 73, 63, 69, 73, 86, 72, 92, 76, 80, 51, 2500000, 2, false);
        Add(50, "BKN", "E.J.", "Liddell", "PF", 25, "USA", 201, 109, 73, 75, 77, 78, 70, 68, 68, 81, 78, 81, 78, 68, 56, 2200000, 1, false);
        ...
        Add(53, "BKN", "Tyler", "Bilodeau", "SF", 22, "USA", 203, 97, 59, 70, 78, 74, 74, 72, 76, 76, 68, 80, 76, 70, 52, 2_000_000, 2, true);

        // ── CHA ──
        Add(54, "CHA", "LaMelo", "Ball", "PG", 25, "USA", 201, 82, 89, 92, 99, 99, 99, 99, 99, 85, 70, 99, 99, 89, 42, 37900000, 4, false);
        Add(55, "CHA", "Brandon", "Miller", "SF", 23, "USA", 206, 91, 87, 93, 95, 97, 93, 89, 97, 87, 77, 95, 95, 81, 51, 16000000, 2, false);
        Add(56, "CHA", "Miles", "Bridges", "PF", 28, "USA", 201, 102, 84, 84, 92, 92, 84, 83, 90, 88, 83, 98, 90, 75, 49, 25000000, 2, false);
        Add(57, "CHA", "Coby", "White", "SG", 26, "USA", 196, 88, 85, 86, 99, 98, 94, 92, 96, 82, 72, 92, 96, 78, 36, 12000000, 2, false);
        Add(58, "CHA", "Tre", "Mann", "PG", 25, "USA", 191, 81, 80, 82, 96, 93, 89, 91, 95, 75, 61, 85, 91, 73, 31, 12000000, 3, false);
        Add(59, "CHA", "Kon", "Knueppel", "SG", 20, "USA", 198, 99, 79, 90, 87, 92, 96, 85, 91, 75, 69, 83, 93, 69, 29, 7000000, 4, false);
        Add(60, "CHA", "Liam", "McNeeley", "SF", 20, "USA", 201, 98, 77, 89, 83, 89, 93, 81, 87, 75, 71, 81, 89, 67, 31, 4500000, 4, false);
        Add(61, "CHA", "Tidjane", "Salaun", "PF", 20, "FRA", 206, 98, 76, 91, 86, 78, 75, 71, 76, 80, 75, 92, 80, 74, 49, 6500000, 3, false);
        Add(62, "CHA", "Ryan", "Kalkbrenner", "C", 23, "USA", 216, 117, 76, 84, 73, 79, 55, 69, 65, 83, 96, 81, 85, 53, 97, 3200000, 4, false);
        Add(63, "CHA", "Josh", "Green", "SG", 25, "AUS", 196, 95, 77, 78, 89, 78, 76, 74, 80, 86, 68, 90, 82, 82, 42, 13000000, 3, false);
        Add(64, "CHA", "Grant", "Williams", "PF", 27, "USA", 198, 107, 77, 77, 78, 84, 82, 76, 74, 86, 80, 80, 88, 72, 47, 13000000, 2, false);
        Add(65, "CHA", "Xavier", "Tillman", "C", 27, "USA", 203, 111, 76, 76, 75, 76, 65, 73, 69, 88, 90, 80, 86, 69, 65, 7000000, 2, false);
        Add(66, "CHA", "Moussa", "Diabate", "C", 23, "FRA", 211, 95, 75, 82, 87, 69, 37, 63, 59, 83, 99, 95, 79, 65, 89, 2500000, 3, false);
        Add(67, "CHA", "Pat", "Connaughton", "SG", 33, "USA", 196, 94, 75, 74, 84, 82, 84, 75, 78, 78, 69, 82, 82, 74, 37, 9400000, 1, false);
        Add(68, "CHA", "Christian", "Anderson Jr.", "PG", 19, "USA", 185, 84, 64, 77, 86, 74, 68, 84, 82, 76, 50, 82, 84, 72, 36, 4_300_000, 4, true);
        Add(69, "CHA", "Hannes", "Steinbach", "PF", 20, "GER", 208, 107, 67, 80, 74, 70, 75, 72, 70, 80, 85, 78, 82, 70, 68, 4_700_000, 4, true);

        // ── CHI ──
        Add(70, "CHI", "Josh", "Giddey", "PG", 23, "AUS", 203, 93, 86, 90, 89, 87, 91, 99, 96, 85, 89, 93, 99, 75, 43, 30000000, 5, false);
        Add(71, "CHI", "Anfernee", "Simons", "SG", 27, "USA", 191, 82, 86, 87, 99, 99, 99, 96, 99, 80, 62, 97, 99, 78, 38, 27000000, 2, false);
        Add(72, "CHI", "Collin", "Sexton", "PG", 27, "USA", 188, 86, 84, 84, 99, 99, 89, 91, 99, 79, 61, 98, 95, 81, 33, 19000000, 2, false);
        Add(73, "CHI", "Matas", "Buzelis", "SF", 21, "USA", 208, 95, 82, 92, 89, 87, 83, 81, 89, 85, 77, 93, 87, 77, 54, 7000000, 3, false);
        Add(74, "CHI", "Isaac", "Okoro", "SF", 25, "USA", 196, 102, 79, 80, 91, 77, 70, 76, 79, 93, 70, 95, 83, 91, 44, 11000000, 2, false);
        Add(75, "CHI", "Patrick", "Williams", "PF", 25, "USA", 201, 97, 78, 82, 84, 80, 78, 72, 76, 87, 76, 89, 82, 84, 50, 18000000, 4, false);
        Add(76, "CHI", "Guerschon", "Yabusele", "PF", 30, "FRA", 203, 118, 79, 79, 82, 87, 86, 78, 80, 84, 84, 86, 88, 72, 42, 12000000, 2, false);
        Add(77, "CHI", "Zach", "Collins", "C", 29, "USA", 211, 113, 78, 78, 74, 82, 76, 82, 76, 84, 90, 80, 88, 64, 62, 18000000, 2, false);
        Add(78, "CHI", "Nick", "Richards", "C", 28, "JAM", 213, 111, 77, 77, 84, 80, 40, 66, 62, 87, 99, 91, 85, 64, 89, 5000000, 2, false);
        Add(79, "CHI", "Tre", "Jones", "PG", 26, "USA", 185, 83, 83, 82, 94, 88, 82, 97, 95, 86, 64, 88, 97, 88, 34, 9000000, 2, false);
        Add(80, "CHI", "Rob", "Dillingham", "PG", 21, "USA", 188, 79, 82, 93, 98, 99, 96, 99, 99, 71, 55, 92, 91, 71, 31, 6500000, 4, false);
        Add(81, "CHI", "Noa", "Essengue", "PF", 19, "FRA", 208, 97, 77, 92, 87, 76, 68, 72, 78, 83, 80, 91, 80, 78, 54, 6500000, 4, false);
        Add(82, "CHI", "Leonard", "Miller", "PF", 22, "CAN", 208, 98, 77, 89, 86, 79, 67, 73, 77, 82, 84, 92, 81, 75, 51, 2800000, 3, false);
        Add(83, "CHI", "Jalen", "Smith", "C", 26, "USA", 208, 98, 77, 80, 78, 82, 78, 71, 70, 82, 90, 82, 82, 63, 69, 9000000, 2, false);
        Add(84, "CHI", "Caleb", "Wilson", "SF", 19, "USA", 206, 96, 78, 92, 94, 75, 70, 75, 80, 87, 80, 96, 78, 72, 60, 9_400_000, 4, true);
        Add(85, "CHI", "Dailyn", "Swain", "SF", 20, "USA", 201, 95, 67, 79, 84, 76, 78, 72, 76, 82, 68, 85, 74, 72, 52, 4_600_000, 4, true);

        // ── CLE ──
        Add(86, "CLE", "Donovan", "Mitchell", "SG", 30, "USA", 191, 97, 93, 93, 99, 99, 99, 99, 99, 99, 81, 99, 99, 99, 51, 54000000, 4, false);
        Add(87, "CLE", "Evan", "Mobley", "PF", 25, "USA", 211, 98, 92, 95, 88, 92, 84, 90, 92, 99, 98, 96, 99, 82, 92, 45000000, 5, false);
        Add(88, "CLE", "James", "Harden", "PG", 37, "USA", 196, 100, 86, 86, 87, 98, 97, 99, 99, 77, 73, 87, 99, 85, 45, 32000000, 2, false);
        Add(89, "CLE", "Jarrett", "Allen", "C", 28, "USA", 206, 110, 86, 86, 91, 89, 47, 79, 75, 99, 99, 98, 97, 73, 99, 30000000, 3, false);
        Add(90, "CLE", "Keon", "Ellis", "SG", 27, "USA", 193, 79, 82, 82, 92, 85, 83, 79, 85, 94, 69, 90, 88, 94, 43, 9000000, 3, false);
        Add(91, "CLE", "Max", "Strus", "SF", 30, "USA", 196, 97, 81, 81, 90, 92, 95, 80, 84, 84, 72, 88, 90, 78, 38, 16000000, 2, false);
        Add(92, "CLE", "Dennis", "Schroder", "PG", 33, "GER", 188, 78, 79, 79, 94, 86, 75, 92, 90, 77, 61, 88, 88, 83, 35, 7000000, 1, false);
        Add(93, "CLE", "Sam", "Merrill", "SG", 30, "USA", 193, 93, 77, 77, 87, 91, 99, 76, 81, 77, 66, 81, 85, 72, 32, 5000000, 2, false);
        Add(94, "CLE", "Larry", "Nance Jr.", "PF", 33, "USA", 201, 111, 77, 77, 79, 78, 74, 76, 74, 87, 81, 83, 87, 72, 56, 6000000, 1, false);
        ...
        Add(98, "CLE", "Dean", "Wade", "PF", 30, "USA", 206, 103, 76, 76, 78, 81, 85, 72, 74, 85, 77, 79, 83, 70, 52, 7000000, 2, false);
        Add(99, "CLE", "Thomas", "Bryant", "C", 29, "USA", 208, 112, 75, 75, 79, 85, 67, 71, 69, 81, 93, 81, 85, 57, 57, 3500000, 1, false);
        Add(100, "CLE", "Meleek", "Thomas", "SG", 19, "USA", 191, 86, 60, 74, 82, 80, 78, 74, 76, 74, 52, 82, 76, 72, 42, 2_000_000, 2, true);

        // ── DAL ──
        Add(101, "DAL", "Kyrie", "Irving", "PG", 34, "USA", 188, 88, 90, 90, 99, 99, 99, 99, 99, 86, 70, 99, 99, 95, 46, 36566002, 2, false);
        Add(102, "DAL", "Cooper", "Flagg", "SF", 19, "USA", 206, 92, 87, 98, 88, 88, 84, 86, 90, 94, 84, 95, 92, 82, 74, 14386320, 4, false);
        Add(103, "DAL", "P.J.", "Washington", "PF", 27, "USA", 201, 104, 84, 84, 88, 90, 86, 82, 86, 92, 86, 92, 90, 78, 54, 14152174, 2, false);
        Add(104, "DAL", "Dereck", "Lively II", "C", 22, "USA", 216, 104, 84, 91, 89, 83, 44, 75, 70, 99, 99, 99, 93, 74, 99, 5253360, 2, false);
        Add(105, "DAL", "Daniel", "Gafford", "C", 27, "USA", 208, 120, 82, 82, 87, 87, 40, 71, 67, 99, 99, 95, 91, 67, 99, 14386320, 2, false);
        Add(106, "DAL", "Klay", "Thompson", "SG", 36, "USA", 196, 99, 81, 81, 85, 97, 99, 79, 85, 85, 71, 83, 95, 73, 39, 16666667, 2, false);
        Add(107, "DAL", "Max", "Christie", "SG", 23, "USA", 196, 86, 79, 86, 88, 81, 81, 77, 83, 88, 69, 90, 83, 86, 43, 7714286, 3, false);
        Add(108, "DAL", "Naji", "Marshall", "SF", 28, "USA", 198, 99, 79, 79, 89, 81, 75, 79, 83, 87, 73, 91, 85, 81, 45, 9000000, 2, false);
        Add(109, "DAL", "Caleb", "Martin", "SF", 30, "USA", 196, 92, 78, 78, 87, 81, 81, 75, 79, 87, 71, 89, 85, 81, 42, 9594044, 2, false);
        Add(110, "DAL", "Khris", "Middleton", "SF", 34, "USA", 201, 100, 81, 81, 79, 94, 94, 91, 92, 81, 75, 81, 96, 69, 39, 33926296, 1, false);
        Add(111, "DAL", "AJ", "Johnson", "PG", 21, "USA", 196, 72, 78, 90, 98, 82, 76, 96, 94, 70, 58, 94, 84, 72, 34, 3090480, 4, false);
        Add(112, "DAL", "Tyler", "Smith", "PF", 21, "USA", 206, 101, 75, 88, 82, 79, 77, 69, 73, 79, 79, 88, 79, 67, 53, 1955377, 3, false);
        Add(113, "DAL", "Ryan", "Nembhard", "PG", 23, "CAN", 180, 81, 76, 82, 96, 79, 75, 98, 94, 67, 53, 80, 90, 77, 27, 321875, 4, false);
        Add(114, "DAL", "Brandon", "Williams", "PG", 26, "USA", 188, 86, 74, 76, 95, 82, 76, 87, 85, 68, 54, 85, 82, 72, 28, 2200000, 1, false);
        Add(115, "DAL", "Marvin", "Bagley III", "PF", 27, "USA", 208, 106, 76, 76, 89, 87, 56, 72, 74, 85, 95, 91, 83, 56, 48, 2296274, 1, false);
        Add(116, "DAL", "Morez", "Johnson Jr.", "PF", 19, "USA", 206, 104, 71, 84, 84, 66, 52, 70, 74, 82, 90, 93, 76, 68, 82, 5_700_000, 4, true);
        Add(117, "DAL", "Sergio", "de Larrea", "SF", 20, "ESP", 203, 91, 63, 77, 78, 74, 78, 76, 78, 80, 62, 78, 82, 68, 48, 3_600_000, 4, true);
        Add(118, "DAL", "Tobi", "Lawal", "PF", 21, "NGA", 203, 102, 57, 70, 84, 62, 50, 64, 66, 78, 80, 90, 68, 68, 72, 2_000_000, 2, true);
        Add(119, "DAL", "Vsevolod", "Ishchenko", "SG", 21, "RUS", 193, 84, 57, 68, 78, 74, 72, 76, 74, 70, 50, 76, 76, 66, 36, 2_000_000, 2, true);

        // ── DEN ──
        Add(120, "DEN", "Nikola", "Jokic", "C", 31, "SRB", 211, 129, 98, 99, 93, 99, 99, 99, 99, 99, 99, 99, 99, 89, 93, 62000000, 4, false);
        Add(121, "DEN", "Jamal", "Murray", "PG", 29, "CAN", 193, 98, 88, 88, 99, 99, 99, 99, 99, 84, 72, 98, 99, 84, 36, 50000000, 4, false);
        Add(122, "DEN", "Aaron", "Gordon", "PF", 31, "USA", 203, 107, 85, 85, 91, 87, 80, 82, 87, 93, 87, 99, 91, 80, 58, 33000000, 3, false);
        Add(123, "DEN", "Cameron", "Johnson", "SF", 30, "USA", 203, 95, 84, 84, 91, 96, 98, 83, 89, 85, 79, 89, 92, 75, 47, 23000000, 2, false);
        Add(124, "DEN", "Christian", "Braun", "SG", 25, "USA", 198, 100, 84, 86, 93, 88, 86, 84, 90, 92, 76, 95, 90, 86, 44, 11000000, 4, false);
        Add(125, "DEN", "Tyus", "Jones", "PG", 30, "USA", 185, 89, 81, 81, 90, 88, 82, 99, 98, 77, 61, 82, 99, 88, 27, 8000000, 2, false);
        Add(126, "DEN", "Jonas", "Valanciunas", "C", 34, "LIT", 211, 120, 80, 80, 73, 93, 73, 85, 79, 89, 99, 79, 99, 57, 54, 10000000, 1, false);
        Add(127, "DEN", "Bruce", "Brown", "SG", 30, "USA", 193, 92, 79, 79, 91, 81, 75, 83, 85, 89, 68, 91, 85, 83, 38, 6000000, 1, false);
        Add(128, "DEN", "Peyton", "Watson", "SF", 23, "USA", 201, 91, 79, 88, 87, 75, 70, 72, 77, 89, 73, 93, 79, 77, 77, 5500000, 3, false);
        Add(129, "DEN", "Julian", "Strawther", "SG", 24, "USA", 198, 93, 78, 84, 90, 88, 92, 79, 87, 77, 67, 85, 87, 71, 35, 3200000, 2, false);
        Add(130, "DEN", "DaRon", "Holmes II", "PF", 23, "USA", 208, 107, 77, 89, 81, 79, 74, 72, 77, 83, 81, 89, 79, 70, 62, 4000000, 4, false);
        Add(131, "DEN", "Jalen", "Pickett", "PG", 27, "USA", 188, 83, 76, 76, 82, 82, 78, 96, 92, 75, 59, 78, 94, 73, 27, 2500000, 2, false);
        Add(132, "DEN", "Tim", "Hardaway Jr.", "SG", 34, "USA", 196, 93, 77, 77, 89, 94, 98, 75, 83, 75, 63, 83, 87, 67, 33, 6000000, 1, false);
        Add(133, "DEN", "Zeke", "Nnaji", "PF", 25, "USA", 206, 109, 73, 78, 81, 74, 64, 68, 70, 81, 83, 85, 77, 64, 56, 8000000, 3, false);
        Add(134, "DEN", "David", "Roddy", "SF", 25, "USA", 193, 116, 72, 74, 80, 77, 75, 69, 73, 78, 73, 84, 77, 67, 39, 2200000, 1, false);
        Add(135, "DEN", "Bryce", "Hopkins", "PF", 23, "USA", 203, 100, 57, 67, 76, 68, 66, 70, 72, 76, 72, 78, 74, 68, 56, 2_000_000, 2, true);
        Add(136, "DEN", "Trevon", "Brazile", "PF", 23, "USA", 206, 97, 60, 72, 82, 66, 60, 70, 72, 80, 76, 84, 72, 70, 62, 2_000_000, 2, true);

        // ── DET ──
        Add(137, "DET", "Cade", "Cunningham", "PG", 25, "USA", 198, 100, 92, 94, 98, 99, 96, 99, 99, 93, 85, 99, 99, 89, 45, 45000000, 5, false);
        Add(138, "DET", "Jalen", "Duren", "C", 22, "USA", 211, 113, 85, 92, 93, 89, 44, 77, 73, 97, 99, 99, 95, 72, 97, 13000000, 3, false);
        Add(139, "DET", "Ausar", "Thompson", "SF", 23, "USA", 201, 98, 84, 92, 93, 78, 66, 82, 85, 97, 80, 99, 87, 95, 62, 10000000, 3, false);
        Add(140, "DET", "Tobias", "Harris", "PF", 34, "USA", 203, 102, 80, 80, 78, 89, 88, 84, 86, 84, 84, 82, 93, 68, 44, 26000000, 1, false);
        Add(141, "DET", "Caris", "LeVert", "SG", 32, "USA", 198, 93, 80, 80, 94, 90, 82, 88, 94, 78, 67, 90, 90, 74, 33, 12000000, 2, false);
        Add(142, "DET", "Kevin", "Huerter", "SG", 28, "USA", 201, 91, 79, 79, 91, 91, 95, 82, 87, 78, 68, 84, 89, 70, 34, 17000000, 2, false);
        Add(143, "DET", "Isaiah", "Stewart", "PF", 25, "USA", 203, 113, 79, 80, 77, 81, 77, 72, 73, 89, 89, 87, 83, 73, 68, 15000000, 3, false);
        ...
        Add(151, "DET", "Ebuka", "Okorie", "PG", 20, "NGA", 185, 84, 65, 78, 90, 78, 72, 82, 84, 76, 52, 88, 78, 80, 38, 4_400_000, 4, true);
        Add(152, "DET", "Ugonna", "Onyenso", "C", 21, "NGA", 213, 107, 57, 70, 70, 54, 36, 58, 58, 76, 94, 78, 70, 60, 92, 2_000_000, 2, true);

        // ── GSW ──
        Add(153, "GSW", "Stephen", "Curry", "PG", 38, "USA", 188, 84, 94, 94, 99, 99, 99, 99, 99, 97, 82, 99, 99, 99, 52, 59600000, 2, false);
        Add(154, "GSW", "Jimmy", "Butler III", "SF", 37, "USA", 201, 104, 89, 89, 91, 97, 83, 95, 97, 97, 81, 95, 99, 91, 53, 54000000, 2, false);
        Add(155, "GSW", "Kristaps", "Porzingis", "C", 31, "LAT", 221, 109, 86, 86, 84, 95, 91, 82, 76, 92, 90, 88, 95, 60, 93, 30700000, 2, false);
        Add(156, "GSW", "Draymond", "Green", "PF", 36, "USA", 198, 104, 83, 83, 76, 76, 70, 94, 86, 98, 84, 82, 99, 92, 56, 26000000, 3, false);
        Add(157, "GSW", "Brandin", "Podziemski", "SG", 23, "USA", 193, 93, 82, 89, 90, 86, 84, 90, 94, 84, 76, 90, 92, 78, 38, 4000000, 2, false);
        Add(158, "GSW", "Moses", "Moody", "SG", 24, "USA", 196, 96, 80, 85, 87, 87, 89, 78, 84, 85, 70, 89, 85, 84, 42, 12000000, 3, false);
        Add(159, "GSW", "De'Anthony", "Melton", "SG", 28, "USA", 188, 91, 79, 79, 91, 81, 77, 81, 83, 93, 67, 87, 85, 91, 33, 9000000, 1, false);
        Add(160, "GSW", "Al", "Horford", "C", 40, "DOM", 206, 109, 78, 78, 67, 80, 80, 82, 74, 86, 86, 70, 96, 61, 76, 9000000, 1, false);
        Add(161, "GSW", "Gary", "Payton II", "SG", 33, "USA", 188, 88, 77, 77, 92, 74, 63, 72, 78, 98, 65, 94, 82, 96, 33, 9000000, 1, false);
        Add(162, "GSW", "Seth", "Curry", "SG", 36, "USA", 188, 76, 76, 76, 88, 96, 99, 84, 88, 68, 55, 78, 92, 61, 27, 5000000, 1, false);
        Add(163, "GSW", "Quinten", "Post", "C", 25, "NED", 213, 111, 75, 82, 72, 83, 85, 70, 68, 78, 89, 78, 82, 52, 68, 2200000, 3, false);
        Add(164, "GSW", "Charles", "Bassey", "C", 26, "NGA", 208, 104, 74, 80, 81, 71, 38, 63, 60, 85, 97, 91, 81, 62, 85, 2500000, 2, false);
        Add(165, "GSW", "Gui", "Santos", "SF", 24, "BRA", 203, 95, 74, 82, 84, 75, 71, 73, 76, 82, 73, 86, 78, 73, 43, 2200000, 3, false);
        Add(166, "GSW", "Yaxel", "Lendeborg", "PF", 22, "VEN", 206, 100, 70, 81, 82, 70, 74, 78, 80, 91, 87, 85, 82, 78, 74, 5_300_000, 4, true);
        Add(167, "GSW", "Lajae", "Jones", "SF", 22, "USA", 201, 97, 57, 67, 78, 70, 68, 68, 72, 74, 64, 80, 70, 68, 52, 2_000_000, 2, true);

        // ── HOU ──
        Add(168, "HOU", "Kevin", "Durant", "SF", 38, "USA", 211, 109, 93, 93, 96, 99, 99, 99, 99, 94, 88, 99, 99, 78, 62, 54700000, 2, false);
        Add(169, "HOU", "Alperen", "Sengun", "C", 24, "TUR", 211, 110, 90, 94, 87, 99, 87, 99, 99, 91, 99, 93, 99, 73, 64, 38000000, 5, false);
        Add(170, "HOU", "Amen", "Thompson", "SF", 23, "USA", 201, 97, 88, 96, 99, 83, 67, 91, 93, 98, 85, 99, 93, 97, 63, 11000000, 3, false);
        Add(171, "HOU", "Fred", "VanVleet", "PG", 32, "USA", 183, 89, 84, 84, 90, 92, 88, 98, 96, 90, 60, 86, 98, 96, 30, 44500000, 2, false);
        Add(172, "HOU", "Jabari", "Smith Jr.", "PF", 23, "USA", 211, 100, 84, 91, 87, 88, 88, 79, 85, 90, 87, 92, 90, 77, 61, 15000000, 2, false);
        Add(173, "HOU", "Tari", "Eason", "SF", 25, "USA", 203, 98, 83, 89, 91, 82, 74, 78, 82, 95, 82, 97, 85, 93, 54, 12000000, 3, false);
        Add(174, "HOU", "Reed", "Sheppard", "PG", 22, "USA", 188, 82, 81, 92, 90, 90, 98, 92, 94, 79, 59, 83, 92, 88, 26, 11000000, 3, false);
        Add(175, "HOU", "Dorian", "Finney-Smith", "SF", 33, "USA", 201, 100, 79, 79, 82, 81, 84, 75, 77, 92, 73, 88, 84, 88, 45, 14000000, 2, false);
        Add(176, "HOU", "Clint", "Capela", "C", 32, "SUI", 208, 116, 79, 79, 84, 78, 39, 69, 63, 98, 99, 92, 88, 65, 94, 9000000, 1, false);
        Add(177, "HOU", "Steven", "Adams", "C", 33, "NZL", 211, 120, 77, 77, 74, 76, 36, 72, 64, 99, 99, 90, 93, 60, 84, 6000000, 1, false);
        Add(178, "HOU", "Josh", "Okogie", "SG", 28, "NGA", 193, 97, 75, 75, 90, 71, 63, 69, 72, 94, 67, 94, 78, 90, 37, 3500000, 1, false);
        Add(179, "HOU", "Aaron", "Holiday", "PG", 30, "USA", 183, 84, 74, 74, 89, 82, 83, 85, 84, 76, 54, 78, 84, 74, 25, 3500000, 1, false);
        Add(180, "HOU", "Jae'Sean", "Tate", "SF", 31, "USA", 193, 104, 74, 74, 81, 75, 65, 71, 75, 87, 73, 89, 79, 81, 38, 3500000, 1, false);
        Add(181, "HOU", "Jeff", "Green", "PF", 40, "USA", 203, 107, 73, 73, 78, 79, 76, 70, 72, 79, 74, 80, 85, 64, 46, 3500000, 1, false);
        Add(182, "HOU", "Tristen", "Newton", "PG", 24, "USA", 196, 86, 72, 80, 87, 75, 73, 87, 85, 71, 58, 79, 81, 70, 26, 2200000, 3, false);
        Add(183, "HOU", "Bruce", "Thornton", "PG", 22, "USA", 191, 97, 62, 72, 83, 82, 80, 82, 80, 76, 52, 82, 82, 74, 38, 2_200_000, 2, true);

        // ── IND ──
        Add(184, "IND", "Tyrese", "Haliburton", "PG", 26, "USA", 196, 84, 93, 95, 99, 99, 99, 99, 99, 99, 83, 99, 99, 99, 49, 55000000, 5, false);
        Add(185, "IND", "Pascal", "Siakam", "PF", 32, "CMR", 203, 104, 89, 89, 92, 99, 84, 95, 97, 94, 88, 97, 99, 82, 52, 52000000, 4, false);
        Add(186, "IND", "Ivica", "Zubac", "C", 29, "CRO", 213, 109, 85, 85, 80, 94, 53, 84, 79, 99, 99, 92, 98, 67, 90, 20000000, 3, false);
        Add(187, "IND", "Andrew", "Nembhard", "PG", 26, "CAN", 193, 87, 84, 86, 92, 89, 83, 98, 96, 88, 67, 90, 98, 88, 35, 18000000, 4, false);
        Add(188, "IND", "Aaron", "Nesmith", "SF", 27, "USA", 198, 98, 82, 83, 90, 88, 90, 77, 83, 90, 73, 92, 86, 90, 43, 16000000, 3, false);
        Add(189, "IND", "Jarace", "Walker", "PF", 22, "USA", 203, 107, 80, 91, 82, 78, 75, 78, 80, 90, 78, 94, 84, 84, 57, 9000000, 3, false);
        Add(190, "IND", "Obi", "Toppin", "PF", 28, "USA", 206, 100, 79, 79, 92, 87, 81, 77, 83, 79, 77, 98, 85, 69, 41, 14000000, 2, false);
        Add(191, "IND", "T.J.", "McConnell", "PG", 34, "USA", 185, 86, 79, 79, 89, 83, 71, 96, 93, 83, 55, 83, 96, 95, 25, 10000000, 2, false);
        Add(192, "IND", "Ben", "Sheppard", "SG", 25, "USA", 198, 86, 77, 82, 86, 82, 88, 78, 82, 84, 66, 84, 84, 80, 33, 3200000, 2, false);
        Add(193, "IND", "Johnny", "Furphy", "SF", 21, "AUS", 206, 86, 76, 89, 86, 81, 84, 75, 81, 81, 67, 88, 81, 73, 39, 2900000, 3, false);
        Add(194, "IND", "Jay", "Huff", "C", 28, "USA", 216, 109, 77, 78, 72, 84, 82, 70, 66, 82, 94, 76, 84, 53, 84, 4500000, 2, false);
        Add(195, "IND", "Kam", "Jones", "PG", 23, "USA", 193, 92, 75, 84, 88, 83, 81, 88, 87, 71, 57, 83, 85, 73, 29, 2800000, 4, false);
        Add(196, "IND", "Kobe", "Brown", "PF", 26, "USA", 201, 113, 74, 78, 80, 78, 74, 72, 74, 82, 78, 84, 80, 68, 44, 2600000, 2, false);
        Add(197, "IND", "Quenton", "Jackson", "SG", 27, "USA", 196, 79, 73, 76, 92, 76, 70, 78, 80, 78, 58, 88, 78, 76, 29, 2200000, 2, false);
        Add(198, "IND", "Braden", "Smith", "PG", 22, "USA", 185, 84, 59, 70, 82, 76, 74, 86, 82, 76, 50, 78, 88, 74, 36, 2_000_000, 2, true);

        // ── LAC ──
        Add(199, "LAC", "Kawhi", "Leonard", "SF", 35, "USA", 201, 102, 92, 92, 89, 99, 92, 94, 99, 99, 85, 94, 99, 96, 55, 50000000, 2, false);
        Add(200, "LAC", "Darius", "Garland", "PG", 26, "USA", 185, 87, 89, 91, 99, 99, 99, 99, 99, 86, 70, 99, 99, 92, 38, 40000000, 4, false);
        Add(201, "LAC", "Bradley", "Beal", "SG", 33, "USA", 193, 94, 85, 85, 97, 99, 96, 95, 99, 80, 64, 94, 99, 76, 36, 5500000, 2, false);
        Add(202, "LAC", "John", "Collins", "PF", 29, "USA", 206, 103, 84, 84, 92, 94, 83, 79, 87, 87, 93, 98, 91, 69, 51, 26000000, 3, false);
        Add(203, "LAC", "Bennedict", "Mathurin", "SG", 24, "CAN", 198, 95, 84, 90, 99, 98, 90, 86, 96, 82, 72, 98, 92, 72, 39, 9000000, 2, false);
        Add(204, "LAC", "Brook", "Lopez", "C", 38, "USA", 216, 127, 80, 80, 63, 89, 87, 73, 69, 91, 96, 69, 95, 53, 95, 9000000, 1, false);
        Add(205, "LAC", "Bogdan", "Bogdanovic", "SG", 34, "SRB", 196, 102, 80, 80, 87, 94, 98, 89, 93, 75, 63, 85, 96, 69, 31, 16000000, 2, false);
        Add(206, "LAC", "Derrick", "Jones Jr.", "SF", 29, "USA", 198, 95, 79, 79, 92, 77, 67, 69, 77, 93, 73, 98, 81, 91, 51, 11000000, 2, false);
        Add(207, "LAC", "Kris", "Dunn", "PG", 32, "USA", 191, 93, 78, 78, 85, 73, 63, 91, 87, 97, 61, 87, 83, 97, 34, 6000000, 2, false);
        Add(208, "LAC", "Nicolas", "Batum", "PF", 38, "FRA", 203, 104, 76, 76, 72, 77, 85, 81, 79, 85, 75, 73, 93, 72, 44, 5000000, 1, false);
        Add(209, "LAC", "Isaiah", "Jackson", "C", 24, "USA", 208, 93, 77, 85, 90, 74, 34, 66, 62, 90, 95, 97, 80, 64, 95, 8000000, 3, false);
        Add(210, "LAC", "Jordan", "Miller", "SG", 25, "USA", 196, 88, 76, 82, 89, 82, 78, 80, 84, 80, 66, 87, 84, 74, 32, 2500000, 2, false);
        Add(211, "LAC", "TyTy", "Washington Jr.", "PG", 24, "USA", 191, 89, 74, 80, 90, 81, 75, 90, 88, 69, 55, 83, 85, 73, 25, 2500000, 2, false);
        Add(212, "LAC", "Cam", "Christie", "SG", 21, "USA", 198, 86, 73, 84, 86, 78, 84, 73, 78, 77, 63, 84, 78, 73, 29, 2200000, 4, false);
        Add(213, "LAC", "Keaton", "Wagler", "PG", 19, "USA", 196, 86, 76, 89, 88, 84, 86, 88, 84, 87, 60, 83, 92, 76, 40, 8_400_000, 4, true);
        Add(214, "LAC", "Baba", "Miller", "SF", 22, "ESP", 203, 100, 59, 71, 80, 66, 62, 68, 70, 80, 74, 82, 72, 70, 60, 2_000_000, 2, true);
        Add(215, "LAC", "Nick", "Martinelli", "SF", 22, "USA", 203, 97, 58, 68, 76, 76, 78, 70, 74, 76, 64, 76, 78, 66, 48, 2_000_000, 2, true);
        Add(216, "LAC", "Narcisse", "Ngoy", "SF", 21, "FRA", 206, 97, 56, 70, 76, 64, 62, 66, 68, 74, 70, 80, 70, 64, 58, 2_000_000, 2, true);

        // ── LAL ──
        Add(217, "LAL", "Luka", "Doncic", "PG", 27, "SLO", 201, 104, 95, 97, 99, 99, 99, 99, 99, 89, 79, 89, 99, 99, 77, 55000000, 5, false);
        Add(218, "LAL", "LeBron", "James", "SF", 42, "USA", 206, 113, 89, 89, 92, 99, 91, 99, 99, 91, 93, 97, 99, 82, 48, 52600000, 1, false);
        Add(219, "LAL", "Austin", "Reaves", "SG", 28, "USA", 196, 89, 86, 88, 96, 99, 96, 99, 99, 82, 71, 92, 99, 78, 35, 30000000, 4, false);
        Add(220, "LAL", "Deandre", "Ayton", "C", 28, "BAH", 213, 113, 84, 84, 89, 97, 52, 81, 78, 97, 99, 93, 95, 66, 77, 34000000, 2, false);
        Add(221, "LAL", "Marcus", "Smart", "PG", 32, "USA", 193, 100, 81, 81, 85, 81, 75, 90, 86, 98, 65, 86, 94, 98, 33, 21000000, 2, false);
        Add(222, "LAL", "Rui", "Hachimura", "PF", 28, "JPN", 203, 104, 80, 80, 87, 93, 83, 78, 83, 83, 81, 93, 89, 66, 44, 18000000, 2, false);
        ...
        Add(226, "LAL", "Maxi", "Kleber", "PF", 34, "GER", 208, 109, 76, 76, 74, 80, 87, 72, 70, 86, 82, 76, 89, 66, 54, 11000000, 1, false);
        Add(227, "LAL", "Nick", "Smith Jr.", "SG", 22, "USA", 188, 84, 76, 87, 95, 87, 85, 87, 89, 69, 55, 87, 85, 71, 26, 4500000, 3, false);
        Add(228, "LAL", "Jaxson", "Hayes", "C", 26, "USA", 213, 100, 75, 80, 89, 78, 34, 62, 60, 86, 93, 97, 80, 60, 86, 3000000, 2, false);
        ...
        Add(231, "LAL", "Luke", "Kennard", "SG", 30, "USA", 196, 93, 76, 76, 87, 90, 99, 83, 88, 69, 59, 81, 90, 61, 29, 9000000, 2, false);
        Add(232, "LAL", "Cameron", "Carr", "SG", 21, "USA", 196, 93, 63, 78, 86, 82, 84, 72, 76, 74, 60, 86, 74, 68, 44, 3_700_000, 4, true);

        // ── MEM ──
        Add(233, "MEM", "Ja", "Morant", "PG", 27, "USA", 188, 79, 91, 93, 99, 99, 99, 99, 99, 93, 79, 99, 99, 98, 49, 44000000, 4, false);
        ...
        Add(238, "MEM", "Santi", "Aldama", "PF", 25, "ESP", 211, 98, 80, 85, 84, 87, 89, 80, 84, 82, 82, 85, 87, 68, 52, 12000000, 4, false);
        Add(239, "MEM", "Ty", "Jerome", "PG", 29, "USA", 196, 88, 80, 80, 89, 93, 89, 98, 97, 73, 57, 83, 99, 77, 25, 9000000, 2, false);
        ...
        Add(247, "MEM", "Cameron", "Boozer", "PF", 19, "USA", 203, 115, 79, 91, 77, 73, 74, 83, 72, 85, 93, 82, 90, 74, 68, 10_500_000, 4, true);
        Add(248, "MEM", "Karim", "Lopez", "SF", 20, "MEX", 203, 95, 64, 76, 80, 70, 70, 72, 74, 78, 68, 80, 76, 70, 52, 4_000_000, 4, true);
        Add(249, "MEM", "Richie", "Saunders", "SG", 24, "USA", 196, 95, 61, 73, 80, 84, 86, 74, 74, 74, 58, 76, 76, 68, 40, 2_000_000, 2, true);

        // ── MIA ──
        Add(250, "MIA", "Bam", "Adebayo", "C", 29, "USA", 206, 116, 90, 90, 88, 91, 78, 90, 91, 99, 97, 97, 99, 88, 72, 51000000, 4, false);
        Add(251, "MIA", "Giannis", "Antetokounmpo", "PF", 32, "GRE", 211, 110, 97, 97, 99, 99, 82, 99, 99, 99, 99, 99, 99, 97, 96, 62000000, 4, false);
        Add(252, "MIA", "Andrew", "Wiggins", "SF", 31, "CAN", 201, 89, 83, 83, 91, 89, 82, 80, 86, 91, 76, 97, 89, 84, 48, 28000000, 2, false);
        Add(253, "MIA", "Norman", "Powell", "SG", 33, "USA", 193, 97, 82, 82, 96, 98, 94, 82, 92, 79, 67, 94, 94, 73, 33, 22000000, 2, false);
        Add(254, "MIA", "Bobby", "Portis", "PF", 32, "USA", 208, 113, 82, 82, 81, 97, 87, 78, 83, 85, 99, 85, 93, 64, 50, 13000000, 2, false);
        Add(255, "MIA", "Davion", "Mitchell", "PG", 28, "USA", 183, 92, 79, 79, 92, 80, 74, 90, 86, 98, 54, 86, 86, 98, 25, 9000000, 2, false);
        Add(256, "MIA", "Nikola", "Jovic", "PF", 23, "SRB", 208, 101, 80, 89, 85, 87, 87, 84, 87, 78, 80, 87, 89, 66, 50, 6000000, 3, false);
        Add(257, "MIA", "Pelle", "Larsson", "SG", 24, "SWE", 196, 98, 76, 82, 85, 80, 82, 78, 82, 84, 66, 87, 82, 78, 32, 2500000, 3, false);
        Add(258, "MIA", "Simone", "Fontecchio", "SF", 31, "ITA", 201, 95, 76, 76, 84, 86, 94, 78, 82, 76, 68, 82, 86, 68, 32, 8000000, 2, false);
        Add(259, "MIA", "Keshad", "Johnson", "PF", 24, "USA", 201, 102, 74, 82, 86, 73, 65, 69, 72, 86, 72, 92, 78, 80, 41, 2000000, 3, false);
        Add(260, "MIA", "Dru", "Smith", "PG", 28, "USA", 191, 92, 73, 73, 85, 74, 68, 84, 82, 84, 52, 82, 80, 87, 25, 2200000, 1, false);
        Add(261, "MIA", "Ryan", "Conwell", "SG", 20, "USA", 193, 86, 59, 71, 82, 78, 72, 72, 74, 72, 54, 82, 74, 70, 40, 2_000_000, 2, true);
        ...
        Add(264, "MIL", "Kasparas", "Jakucionis", "PG", 20, "LIT", 196, 91, 78, 92, 89, 85, 87, 95, 93, 73, 59, 85, 89, 75, 28, 7000000, 4, false);
        ...
        Add(271, "MIL", "Taurean", "Prince", "SF", 32, "USA", 198, 99, 77, 77, 83, 84, 90, 75, 79, 85, 69, 83, 85, 79, 35, 6000000, 1, false);
        ...
        Add(274, "MIL", "Ousmane", "Dieng", "SF", 23, "FRA", 208, 84, 76, 89, 85, 75, 73, 79, 81, 85, 69, 91, 79, 77, 42, 5000000, 3, false);
        Add(275, "MIL", "Jericho", "Sims", "C", 28, "USA", 208, 113, 74, 76, 86, 72, 34, 62, 58, 88, 95, 95, 80, 58, 86, 3000000, 2, false);
        Add(276, "MIL", "Gary", "Harris", "SG", 32, "USA", 193, 95, 73, 73, 83, 77, 81, 73, 77, 83, 59, 81, 83, 79, 27, 3000000, 1, false);
        Add(277, "MIL", "Pete", "Nance", "PF", 26, "USA", 208, 102, 71, 76, 76, 76, 78, 68, 70, 78, 79, 76, 78, 58, 44, 1800000, 2, false);
        Add(278, "MIL", "Thanasis", "Antetokounmpo", "SF", 34, "GRE", 201, 99, 68, 68, 87, 68, 40, 60, 64, 83, 68, 91, 74, 77, 36, 1200000, 1, false);
        Add(279, "MIL", "Brayden", "Burries", "SG", 19, "USA", 193, 97, 70, 83, 87, 82, 84, 74, 78, 84, 64, 90, 76, 80, 50, 5_300_000, 4, true);
        Add(280, "MIL", "Nate", "Ament", "SF", 19, "USA", 208, 102, 68, 82, 80, 72, 76, 72, 76, 82, 80, 82, 80, 72, 62, 4_800_000, 4, true);
        Add(281, "MIL", "Malique", "Lewis", "SF", 23, "TTO", 201, 95, 55, 64, 76, 66, 68, 66, 68, 72, 60, 76, 68, 66, 46, 2_000_000, 2, true);

        // ── MIN ──
        Add(282, "MIN", "Anthony", "Edwards", "SG", 25, "USA", 193, 102, 95, 97, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 66, 58000000, 5, false);
        Add(283, "MIN", "Julius", "Randle", "PF", 31, "USA", 203, 113, 86, 86, 95, 97, 84, 87, 91, 89, 91, 95, 95, 72, 50, 33000000, 3, false);
        ...
        Add(287, "MIN", "Naz", "Reid", "C", 27, "USA", 206, 113, 82, 88, 86, 93, 89, 80, 84, 84, 89, 86, 87, 66, 58, 16000000, 4, false);
        Add(288, "MIN", "Mike", "Conley", "PG", 38, "USA", 185, 79, 80, 80, 84, 90, 91, 98, 97, 76, 52, 82, 95, 90, 25, 10000000, 1, false);
        ...
        Add(294, "MIN", "Joe", "Ingles", "SF", 38, "AUS", 203, 102, 74, 74, 63, 79, 92, 88, 90, 81, 65, 71, 89, 71, 25, 3000000, 1, false);
        Add(295, "MIN", "Trey", "Kaufman-Renn", "PF", 22, "USA", 206, 109, 57, 65, 72, 66, 52, 66, 66, 76, 84, 76, 78, 64, 72, 2_000_000, 2, true);
        Add(296, "MIN", "Isaiah", "Evans", "SG", 19, "USA", 198, 91, 61, 76, 84, 80, 76, 74, 76, 74, 60, 84, 74, 70, 46, 2_000_000, 2, true);

        // ── NOP ──
        Add(297, "NOP", "Zion", "Williamson", "PF", 26, "USA", 201, 129, 95, 96, 99, 99, 89, 98, 99, 99, 99, 99, 99, 88, 77, 60000000, 4, false);
        Add(298, "NOP", "Dejounte", "Murray", "PG", 30, "USA", 193, 83, 85, 86, 97, 89, 81, 97, 95, 91, 68, 91, 95, 97, 34, 28000000, 3, false);
        Add(299, "NOP", "Jordan", "Poole", "SG", 27, "USA", 193, 88, 82, 88, 99, 99, 97, 87, 95, 73, 55, 93, 95, 75, 34, 25000000, 3, false);
        Add(300, "NOP", "Trey", "Murphy III", "SF", 26, "USA", 206, 95, 84, 90, 93, 95, 97, 81, 89, 87, 71, 95, 93, 81, 42, 16000000, 4, false);
        Add(301, "NOP", "Herbert", "Jones", "SF", 27, "USA", 201, 95, 83, 83, 88, 85, 73, 83, 84, 99, 79, 99, 88, 98, 37, 14000000, 3, false);
        Add(302, "NOP", "Saddiq", "Bey", "SF", 27, "USA", 203, 102, 81, 81, 89, 92, 92, 81, 87, 83, 73, 89, 89, 79, 37, 12000000, 2, false);
        Add(303, "NOP", "Kevon", "Looney", "C", 30, "USA", 206, 111, 80, 80, 71, 83, 52, 79, 75, 97, 99, 85, 89, 59, 91, 12000000, 2, false);
        Add(304, "NOP", "Yves", "Missi", "C", 22, "CMR", 213, 104, 80, 90, 86, 83, 41, 71, 67, 94, 99, 94, 86, 63, 96, 9000000, 4, false);
        Add(305, "NOP", "Hunter", "Dickinson", "C", 25, "USA", 213, 118, 78, 84, 63, 85, 55, 77, 71, 89, 99, 81, 91, 54, 93, 6000000, 2, false);
        Add(306, "NOP", "DeAndre", "Jordan", "C", 38, "USA", 211, 120, 74, 74, 57, 77, 27, 67, 65, 95, 98, 85, 93, 57, 93, 3000000, 1, false);
        Add(307, "NOP", "Jordan", "Hawkins", "SG", 23, "USA", 193, 88, 78, 86, 96, 98, 99, 78, 86, 70, 56, 86, 88, 70, 31, 4000000, 3, false);
        Add(308, "NOP", "Trey", "Alexander", "SG", 23, "USA", 193, 86, 76, 84, 94, 90, 88, 83, 86, 73, 55, 86, 85, 71, 25, 2500000, 4, false);
        Add(309, "NOP", "Bryce", "McGowens", "SG", 24, "USA", 198, 90, 75, 84, 97, 89, 83, 79, 83, 72, 56, 85, 83, 70, 28, 2000000, 3, false);
        Add(310, "NOP", "Jeremiah", "Fears", "PG", 20, "USA", 188, 82, 78, 92, 99, 90, 88, 94, 92, 68, 55, 88, 86, 72, 26, 5000000, 4, false);
        Add(311, "NOP", "Derik", "Queen", "PF", 20, "USA", 208, 110, 77, 90, 79, 84, 71, 75, 77, 85, 90, 86, 86, 61, 53, 4000000, 4, false);
        Add(312, "NOP", "Jaron", "Pierre Jr.", "PG", 22, "USA", 191, 86, 57, 66, 82, 78, 72, 78, 76, 72, 50, 80, 76, 72, 40, 2_000_000, 2, true);

        // ── NYK ──
        Add(313, "NYK", "Jalen", "Brunson", "PG", 29, "USA", 188, 86, 93, 93, 99, 99, 99, 99, 99, 95, 81, 99, 99, 99, 55, 48000000, 4, false);
        Add(314, "NYK", "Karl-Anthony", "Towns", "C", 30, "USA", 213, 112, 92, 93, 93, 99, 99, 93, 95, 85, 93, 95, 99, 74, 54, 52000000, 4, false);
        Add(315, "NYK", "Mikal", "Bridges", "SF", 30, "USA", 198, 95, 87, 87, 95, 92, 86, 84, 90, 99, 82, 99, 93, 97, 40, 30000000, 4, false);
        Add(316, "NYK", "OG", "Anunoby", "SF", 29, "GBR", 201, 105, 87, 87, 94, 88, 83, 85, 88, 99, 85, 99, 94, 99, 43, 28000000, 4, false);
        Add(317, "NYK", "Josh", "Hart", "SG", 31, "USA", 196, 97, 84, 84, 90, 86, 82, 86, 88, 96, 78, 94, 90, 92, 42, 18000000, 3, false);
        Add(318, "NYK", "Mitchell", "Robinson", "C", 28, "USA", 213, 111, 83, 83, 89, 79, 38, 71, 68, 99, 99, 99, 99, 73, 99, 14000000, 3, false);
        Add(319, "NYK", "Miles", "McBride", "PG", 26, "USA", 185, 88, 81, 81, 92, 86, 85, 90, 88, 94, 63, 88, 86, 92, 27, 10000000, 3, false);
        Add(320, "NYK", "Jordan", "Clarkson", "SG", 33, "USA", 193, 88, 81, 81, 98, 99, 99, 88, 94, 67, 57, 87, 94, 75, 33, 14000000, 2, false);
        Add(321, "NYK", "Tyler", "Kolek", "PG", 25, "USA", 188, 84, 78, 84, 91, 90, 88, 98, 97, 68, 50, 84, 91, 76, 25, 4000000, 3, false);
        Add(322, "NYK", "Landry", "Shamet", "SG", 29, "USA", 193, 88, 76, 76, 89, 91, 99, 77, 85, 71, 59, 81, 89, 67, 28, 6000000, 1, false);
        Add(323, "NYK", "Jeremy", "Sochan", "PF", 23, "USA", 203, 104, 82, 88, 89, 84, 72, 84, 86, 97, 78, 97, 88, 91, 36, 9000000, 3, false);
        Add(324, "NYK", "Pacome", "Dadiet", "SF", 20, "FRA", 203, 93, 76, 88, 86, 79, 77, 75, 79, 84, 67, 90, 83, 79, 37, 3000000, 4, false);
        Add(325, "NYK", "Kevin", "McCullar Jr.", "SF", 25, "USA", 198, 97, 75, 82, 85, 78, 70, 74, 78, 91, 66, 91, 81, 83, 28, 2500000, 3, false);
        Add(326, "NYK", "Ariel", "Hukporti", "C", 23, "GER", 213, 110, 74, 84, 73, 71, 29, 63, 59, 93, 96, 94, 85, 57, 94, 2200000, 3, false);
        Add(327, "NYK", "Tyler", "Nickel", "SF", 21, "USA", 203, 97, 57, 68, 76, 72, 76, 70, 74, 76, 66, 78, 76, 68, 50, 2_000_000, 2, true);
        Add(328, "NYK", "Jack", "Kayil", "PG", 20, "GER", 191, 84, 58, 70, 80, 72, 70, 80, 78, 72, 50, 78, 80, 68, 36, 2_000_000, 2, true);

        // ── OKC ──
        Add(329, "OKC", "Shai", "Gilgeous-Alexander", "PG", 27, "CAN", 198, 88, 98, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 77, 62000000, 5, false);
        Add(330, "OKC", "Jalen", "Williams", "SF", 25, "USA", 198, 95, 92, 94, 99, 99, 98, 94, 99, 99, 85, 99, 99, 98, 43, 38000000, 4, false);
        Add(331, "OKC", "Chet", "Holmgren", "C", 24, "USA", 216, 97, 90, 92, 87, 94, 89, 83, 87, 96, 99, 93, 94, 69, 99, 36000000, 4, false);
        Add(332, "OKC", "Isaiah", "Hartenstein", "C", 28, "GER", 213, 113, 84, 84, 79, 84, 61, 82, 79, 96, 98, 90, 92, 67, 96, 18000000, 3, false);
        Add(333, "OKC", "Luguentz", "Dort", "SG", 27, "CAN", 193, 99, 84, 84, 95, 86, 76, 84, 85, 99, 70, 99, 91, 97, 42, 16000000, 3, false);
        Add(334, "OKC", "Alex", "Caruso", "SG", 32, "USA", 196, 92, 82, 82, 88, 82, 76, 86, 88, 97, 72, 98, 92, 98, 25, 14000000, 2, false);
        Add(335, "OKC", "Isaiah", "Joe", "SG", 27, "USA", 193, 88, 80, 80, 92, 98, 99, 86, 92, 76, 60, 82, 94, 74, 27, 8000000, 2, false);
        Add(336, "OKC", "Aaron", "Wiggins", "SF", 27, "USA", 198, 93, 80, 82, 92, 88, 86, 80, 84, 88, 71, 90, 88, 84, 29, 7000000, 3, false);
        Add(337, "OKC", "Cason", "Wallace", "PG", 22, "USA", 191, 88, 82, 88, 93, 85, 79, 91, 89, 94, 65, 93, 87, 93, 33, 9000000, 4, false);
        Add(338, "OKC", "Kenrich", "Williams", "PF", 30, "USA", 198, 99, 78, 78, 78, 80, 74, 80, 82, 89, 78, 89, 85, 87, 36, 7000000, 2, false);
        Add(339, "OKC", "Jaylin", "Williams", "C", 23, "USA", 206, 108, 78, 84, 71, 77, 71, 77, 79, 82, 82, 81, 82, 73, 83, 6000000, 3, false);
        Add(340, "OKC", "Nikola", "Topic", "PG", 20, "SRB", 198, 88, 78, 92, 92, 86, 85, 98, 96, 73, 53, 85, 90, 71, 29, 5000000, 4, false);
        Add(341, "OKC", "Jared", "McCain", "SG", 22, "USA", 191, 88, 80, 88, 97, 97, 99, 87, 91, 73, 57, 85, 93, 71, 30, 6000000, 4, false);
        Add(342, "OKC", "Ajay", "Mitchell", "PG", 23, "BEL", 193, 86, 75, 84, 90, 83, 79, 86, 84, 79, 59, 83, 84, 73, 25, 2000000, 4, false);
        Add(343, "OKC", "Aday", "Mara", "C", 20, "ESP", 221, 109, 68, 82, 72, 64, 66, 65, 60, 78, 95, 80, 80, 62, 90, 5_000_000, 4, true);
        Add(344, "OKC", "Bennett", "Stirtz", "PG", 22, "USA", 191, 86, 67, 75, 84, 82, 80, 82, 80, 80, 55, 80, 86, 76, 38, 4_500_000, 4, true);
        Add(345, "OKC", "Otega", "Oweh", "SG", 22, "USA", 196, 97, 59, 70, 86, 76, 64, 72, 74, 82, 58, 86, 70, 82, 48, 2_000_000, 2, true);

        // ── ORL ──
        Add(346, "ORL", "Paolo", "Banchero", "PF", 26, "USA", 208, 113, 92, 94, 99, 99, 93, 95, 98, 96, 94, 99, 99, 79, 61, 48000000, 5, false);
        Add(347, "ORL", "Franz", "Wagner", "SF", 25, "GER", 206, 100, 88, 90, 95, 97, 94, 92, 95, 95, 78, 95, 95, 86, 46, 30000000, 4, false);
        Add(348, "ORL", "Desmond", "Bane", "SG", 28, "USA", 196, 98, 88, 88, 99, 99, 99, 92, 99, 86, 72, 94, 99, 88, 41, 35000000, 4, false);
        Add(349, "ORL", "Jalen", "Suggs", "PG", 25, "USA", 191, 93, 84, 86, 94, 88, 82, 90, 92, 96, 69, 94, 90, 94, 35, 22000000, 4, false);
        Add(350, "ORL", "Wendell", "Carter Jr.", "C", 27, "USA", 208, 113, 84, 84, 78, 86, 76, 80, 78, 94, 95, 90, 90, 62, 95, 18000000, 3, false);
        Add(351, "ORL", "Jonathan", "Isaac", "PF", 28, "USA", 208, 104, 82, 82, 84, 76, 66, 72, 76, 98, 86, 98, 84, 96, 66, 17000000, 3, false);
        Add(352, "ORL", "Anthony", "Black", "PG", 22, "USA", 198, 95, 80, 86, 90, 82, 76, 88, 88, 92, 67, 90, 84, 90, 33, 9000000, 4, false);
        Add(353, "ORL", "Jett", "Howard", "SG", 23, "USA", 198, 92, 78, 84, 91, 91, 99, 82, 87, 74, 62, 83, 89, 72, 28, 6000000, 4, false);
        Add(354, "ORL", "Moritz", "Wagner", "C", 29, "GER", 211, 111, 80, 80, 83, 92, 87, 81, 85, 79, 88, 81, 88, 63, 53, 12000000, 2, false);
        Add(355, "ORL", "Goga", "Bitadze", "C", 27, "GEO", 211, 113, 78, 78, 75, 81, 53, 71, 69, 91, 92, 89, 85, 59, 93, 8000000, 2, false);
        Add(356, "ORL", "Tristan", "da Silva", "SF", 24, "GER", 206, 98, 78, 86, 84, 85, 88, 79, 83, 83, 71, 86, 85, 81, 33, 5000000, 4, false);
        Add(357, "ORL", "Jevon", "Carter", "PG", 31, "USA", 188, 90, 76, 76, 85, 79, 79, 83, 85, 87, 56, 87, 81, 89, 25, 7000000, 1, false);
        Add(358, "ORL", "Jamal", "Cain", "SF", 27, "USA", 198, 95, 74, 82, 86, 78, 73, 74, 78, 84, 67, 86, 80, 82, 26, 2000000, 2, false);
        Add(359, "ORL", "Izaiyah", "Nelson", "PF", 22, "USA", 206, 104, 56, 67, 74, 58, 46, 62, 62, 76, 84, 82, 70, 66, 76, 2_000_000, 2, true);

        // ── PHI ──
        Add(360, "PHI", "Joel", "Embiid", "C", 32, "CAM", 213, 127, 92, 93, 99, 99, 98, 99, 99, 99, 99, 99, 99, 79, 87, 65000000, 5, false);
        Add(361, "PHI", "Tyrese", "Maxey", "PG", 26, "USA", 188, 86, 92, 94, 99, 99, 99, 99, 99, 94, 74, 99, 99, 99, 52, 42000000, 5, false);
        Add(362, "PHI", "Paul", "George", "SF", 36, "USA", 206, 100, 88, 88, 96, 98, 98, 87, 93, 99, 73, 98, 96, 99, 31, 35000000, 2, false);
        Add(363, "PHI", "Kelly", "Oubre Jr.", "SF", 30, "USA", 198, 95, 80, 82, 93, 89, 86, 80, 84, 89, 66, 89, 87, 87, 30, 12000000, 2, false);
        Add(364, "PHI", "Quentin", "Grimes", "SG", 26, "USA", 196, 92, 82, 84, 93, 93, 93, 82, 88, 88, 66, 90, 91, 88, 30, 9000000, 3, false);
        ...
        Add(371, "PHI", "Adem", "Bona", "C", 22, "NGR", 208, 104, 78, 88, 80, 78, 48, 66, 68, 92, 96, 92, 86, 58, 94, 3000000, 4, false);
        Add(372, "PHI", "Johni", "Broome", "C", 24, "USA", 206, 110, 76, 82, 72, 80, 56, 68, 70, 87, 91, 84, 85, 54, 89, 3000000, 3, false);
        Add(373, "PHI", "MarJon", "Beauchamp", "SF", 25, "USA", 201, 95, 76, 84, 93, 81, 74, 76, 80, 85, 68, 89, 83, 81, 26, 2500000, 3, false);
        Add(374, "PHI", "Labaron", "Philon Jr.", "PG", 20, "USA", 191, 86, 64, 77, 86, 80, 74, 80, 82, 74, 52, 84, 80, 74, 38, 3_900_000, 4, true);

        // ── PHX ──
        Add(375, "PHX", "Devin", "Booker", "SG", 29, "USA", 198, 96, 91, 92, 99, 99, 99, 99, 99, 99, 93, 99, 99, 99, 61, 60000000, 5, false);
        Add(376, "PHX", "Jalen", "Green", "SG", 24, "USA", 198, 89, 86, 90, 99, 99, 99, 94, 98, 78, 63, 96, 99, 80, 41, 35000000, 4, false);
        Add(377, "PHX", "Mark", "Williams", "C", 25, "USA", 213, 118, 84, 86, 84, 88, 48, 74, 76, 99, 99, 96, 95, 66, 99, 22000000, 4, false);
        Add(378, "PHX", "Dillon", "Brooks", "SF", 30, "CAN", 198, 102, 82, 82, 93, 87, 84, 82, 86, 95, 70, 95, 89, 93, 28, 20000000, 3, false);
        Add(379, "PHX", "Grayson", "Allen", "SG", 30, "USA", 193, 90, 82, 82, 93, 97, 99, 87, 93, 83, 61, 85, 93, 85, 26, 15000000, 2, false);
        Add(380, "PHX", "Royce", "O'Neale", "SF", 32, "USA", 198, 104, 80, 80, 85, 83, 87, 83, 87, 92, 71, 91, 87, 89, 25, 11000000, 2, false);
        Add(381, "PHX", "Ryan", "Dunn", "SF", 23, "USA", 203, 98, 78, 88, 90, 80, 74, 76, 80, 92, 70, 94, 86, 90, 26, 5000000, 4, false);
        Add(382, "PHX", "Khaman", "Maluach", "C", 20, "SUD", 218, 110, 78, 92, 75, 79, 48, 64, 65, 93, 99, 91, 89, 58, 97, 6000000, 4, false);
        Add(383, "PHX", "Oso", "Ighodaro", "C", 23, "USA", 208, 104, 78, 86, 78, 76, 55, 69, 71, 90, 94, 88, 86, 61, 90, 4000000, 3, false);
        Add(384, "PHX", "Jordan", "Goodwin", "PG", 27, "USA", 193, 92, 78, 78, 88, 82, 78, 86, 88, 88, 60, 89, 84, 90, 25, 4000000, 2, false);
        Add(385, "PHX", "Collin", "Gillespie", "PG", 27, "USA", 185, 84, 76, 80, 88, 86, 88, 94, 92, 68, 51, 80, 88, 76, 25, 3000000, 2, false);
        Add(386, "PHX", "Amir", "Coffey", "SG", 28, "USA", 198, 93, 76, 78, 88, 83, 81, 79, 83, 85, 59, 87, 83, 83, 25, 3000000, 1, false);
        Add(387, "PHX", "Koa", "Peat", "SF", 19, "USA", 201, 102, 62, 74, 84, 68, 66, 68, 70, 80, 74, 86, 72, 72, 58, 3_400_000, 4, true);

        // ── POR ──
        Add(388, "POR", "Damian", "Lillard", "PG", 36, "USA", 188, 88, 92, 92, 99, 99, 99, 99, 99, 95, 75, 99, 99, 99, 50, 40000000, 2, false);
        Add(389, "POR", "Scoot", "Henderson", "PG", 22, "USA", 191, 90, 88, 92, 99, 99, 94, 99, 99, 83, 67, 98, 99, 88, 43, 12000000, 4, false);
        Add(390, "POR", "Shaedon", "Sharpe", "SG", 23, "CAN", 198, 93, 90, 94, 99, 99, 99, 98, 99, 90, 75, 99, 99, 88, 45, 18000000, 4, false);
        Add(391, "POR", "Jrue", "Holiday", "PG", 35, "USA", 193, 95, 84, 84, 91, 87, 81, 95, 95, 95, 69, 96, 95, 95, 25, 25000000, 2, false);
        Add(392, "POR", "Jerami", "Grant", "PF", 32, "USA", 206, 102, 84, 84, 93, 93, 90, 86, 90, 93, 78, 91, 91, 89, 30, 28000000, 3, false);
        Add(393, "POR", "Deni", "Avdija", "SF", 26, "ISR", 206, 100, 84, 86, 92, 88, 82, 88, 90, 95, 80, 93, 92, 94, 30, 16000000, 3, false);
        Add(394, "POR", "Toumani", "Camara", "SF", 25, "BEL", 198, 98, 82, 86, 91, 85, 78, 83, 85, 97, 76, 95, 89, 95, 28, 8000000, 3, false);
        Add(395, "POR", "Donovan", "Clingan", "C", 22, "USA", 218, 120, 84, 86, 78, 90, 39, 75, 76, 99, 99, 99, 99, 71, 99, 9000000, 4, false);
        Add(396, "POR", "Robert", "Williams III", "C", 28, "USA", 208, 108, 82, 82, 86, 82, 41, 70, 69, 99, 99, 98, 94, 65, 99, 12000000, 2, false);
        Add(397, "POR", "Matisse", "Thybulle", "SG", 29, "AUS", 196, 95, 80, 80, 94, 80, 70, 76, 80, 99, 69, 99, 88, 99, 26, 9000000, 2, false);
        Add(398, "POR", "Blake", "Wesley", "PG", 23, "USA", 193, 86, 78, 84, 93, 85, 80, 84, 85, 87, 58, 89, 86, 86, 25, 3000000, 3, false);
        Add(399, "POR", "Vit", "Krejci", "SG", 26, "CZE", 198, 88, 76, 78, 87, 87, 88, 83, 85, 79, 57, 83, 85, 77, 25, 4000000, 2, false);
        Add(400, "POR", "Caleb", "Love", "PG", 24, "USA", 188, 84, 76, 86, 97, 91, 93, 83, 87, 70, 50, 83, 85, 71, 26, 2500000, 4, false);
        Add(401, "POR", "Kris", "Murray", "SF", 25, "USA", 203, 98, 76, 84, 85, 83, 79, 77, 81, 87, 69, 85, 83, 81, 26, 3000000, 3, false);

        // ── SAC ──
        Add(402, "SAC", "Domantas", "Sabonis", "C", 30, "LTU", 211, 115, 90, 90, 89, 98, 87, 96, 98, 89, 91, 92, 98, 71, 81, 48000000, 5, false);
        Add(403, "SAC", "Zach", "LaVine", "SG", 31, "USA", 196, 91, 88, 90, 99, 99, 99, 98, 99, 83, 65, 99, 99, 85, 43, 40000000, 4, false);
        Add(404, "SAC", "DeMar", "DeRozan", "SF", 36, "USA", 201, 100, 86, 86, 99, 99, 98, 92, 98, 82, 69, 96, 99, 79, 35, 25000000, 2, false);
        Add(405, "SAC", "Malik", "Monk", "SG", 28, "USA", 191, 90, 85, 88, 99, 99, 99, 93, 98, 75, 61, 94, 99, 81, 37, 18000000, 3, false);
        Add(406, "SAC", "Keegan", "Murray", "SF", 26, "USA", 203, 102, 84, 86, 90, 92, 94, 84, 88, 92, 77, 92, 92, 90, 33, 22000000, 4, false);
        Add(407, "SAC", "De'Andre", "Hunter", "SF", 28, "USA", 203, 102, 83, 84, 89, 91, 85, 81, 85, 96, 77, 94, 91, 93, 31, 20000000, 3, false);
        Add(408, "SAC", "Russell", "Westbrook", "PG", 37, "USA", 191, 91, 82, 82, 99, 93, 79, 98, 99, 75, 59, 93, 94, 87, 26, 8000000, 1, false);
        Add(409, "SAC", "Devin", "Carter", "PG", 23, "USA", 188, 86, 80, 86, 94, 86, 80, 90, 88, 88, 61, 90, 86, 90, 27, 6000000, 4, false);
        Add(410, "SAC", "Doug", "McDermott", "SF", 34, "USA", 201, 102, 78, 78, 90, 99, 99, 80, 88, 73, 59, 78, 94, 71, 27, 5000000, 1, false);
        Add(411, "SAC", "Patrick", "Baldwin Jr.", "SF", 23, "USA", 206, 100, 76, 84, 85, 87, 89, 76, 80, 82, 64, 83, 85, 80, 25, 3000000, 3, false);
        Add(412, "SAC", "Precious", "Achiuwa", "PF", 27, "NGR", 203, 104, 80, 82, 91, 84, 70, 78, 80, 93, 86, 93, 87, 86, 32, 9000000, 2, false);
        Add(413, "SAC", "Drew", "Eubanks", "C", 29, "USA", 208, 111, 78, 78, 77, 81, 53, 69, 71, 90, 92, 89, 87, 57, 92, 5000000, 2, false);
        Add(414, "SAC", "Killian", "Hayes", "PG", 25, "FRA", 196, 88, 76, 80, 86, 79, 73, 86, 88, 85, 61, 87, 81, 85, 25, 4000000, 2, false);
        Add(415, "SAC", "Maxime", "Raynaud", "C", 23, "FRA", 213, 110, 76, 84, 72, 79, 73, 70, 73, 81, 87, 79, 81, 54, 87, 3000000, 4, false);
        Add(416, "SAC", "Alex", "Karaban", "SF", 22, "USA", 206, 100, 63, 73, 76, 74, 78, 70, 74, 82, 72, 76, 84, 70, 56, 3_400_000, 4, true);
        Add(417, "SAC", "Darius", "Acuff Jr.", "PG", 19, "USA", 191, 88, 74, 87, 89, 88, 80, 85, 86, 76, 55, 88, 80, 78, 44, 6_700_000, 4, true);
        Add(418, "SAS", "Maliq", "Brown", "SF", 22, "USA", 201, 95, 58, 69, 80, 64, 56, 66, 70, 84, 70, 84, 70, 84, 56, 2_000_000, 2, true);
        Add(419, "SAC", "Emanuel", "Sharp", "SG", 22, "USA", 191, 86, 58, 68, 78, 80, 84, 72, 74, 80, 54, 76, 74, 78, 38, 2_000_000, 2, true);

        // ── SAS ──
        Add(420, "SAS", "Victor", "Wembanyama", "C", 22, "FRA", 224, 104, 94, 99, 90, 99, 86, 92, 95, 99, 99, 99, 99, 99, 99, 60000000, 5, false);
        Add(421, "SAS", "De'Aaron", "Fox", "PG", 28, "USA", 191, 84, 90, 92, 99, 99, 99, 99, 99, 86, 68, 99, 99, 96, 47, 45000000, 5, false);
        Add(422, "SAS", "Stephon", "Castle", "SG", 21, "USA", 198, 96, 84, 88, 96, 92, 84, 90, 92, 88, 69, 92, 92, 90, 39, 9000000, 4, false);
        Add(423, "SAS", "Dylan", "Harper", "SG", 20, "USA", 196, 92, 82, 90, 97, 93, 88, 88, 90, 84, 62, 90, 90, 86, 34, 7000000, 4, false);
        Add(424, "SAS", "Devin", "Vassell", "SG", 27, "USA", 198, 94, 84, 86, 95, 95, 94, 86, 90, 90, 68, 92, 94, 88, 32, 22000000, 4, false);
        Add(425, "SAS", "Keldon", "Johnson", "SF", 26, "USA", 198, 100, 82, 84, 94, 94, 88, 84, 88, 86, 71, 90, 92, 84, 31, 18000000, 3, false);
        Add(426, "SAS", "Harrison", "Barnes", "SF", 34, "USA", 203, 102, 80, 80, 86, 89, 87, 84, 87, 88, 72, 88, 88, 86, 25, 18000000, 2, false);
        Add(427, "SAS", "Julian", "Champagnie", "SF", 26, "USA", 203, 98, 78, 82, 87, 89, 91, 79, 83, 85, 65, 85, 85, 83, 26, 6000000, 2, false);
        Add(428, "SAS", "Luke", "Kornet", "C", 30, "USA", 216, 113, 78, 76, 72, 80, 57, 69, 71, 90, 94, 86, 88, 57, 94, 5000000, 2, false);
        Add(429, "SAS", "Mason", "Plumlee", "C", 36, "USA", 211, 115, 76, 74, 70, 74, 57, 67, 69, 88, 92, 84, 86, 57, 92, 4000000, 1, false);
        Add(430, "SAS", "Kelly", "Olynyk", "PF", 35, "CAN", 211, 108, 78, 78, 77, 88, 86, 83, 86, 81, 77, 81, 87, 75, 37, 12000000, 2, false);
        Add(431, "SAS", "Bismack", "Biyombo", "C", 33, "COD", 206, 116, 76, 72, 72, 70, 31, 61, 62, 98, 99, 96, 92, 57, 98, 5000000, 1, false);
        Add(432, "SAS", "Harrison", "Ingram", "SF", 24, "USA", 201, 95, 74, 82, 85, 79, 78, 76, 79, 83, 64, 83, 81, 81, 25, 2500000, 3, false);
        Add(433, "SAS", "Jayden", "Quaintance", "PF", 19, "USA", 206, 104, 65, 79, 82, 62, 54, 66, 68, 84, 90, 90, 74, 70, 82, 4_100_000, 4, true);
        Add(434, "SAS", "Tarris", "Reed Jr.", "C", 22, "USA", 206, 113, 64, 74, 72, 64, 44, 64, 60, 78, 92, 82, 78, 66, 82, 3_600_000, 4, true);
        Add(435, "SAS", "Ja'Kobi", "Gillespie", "PG", 22, "USA", 191, 88, 59, 70, 84, 80, 68, 80, 78, 80, 52, 82, 78, 82, 44, 2_000_000, 2, true);

        // ── TOR ──
        Add(436, "TOR", "Scottie", "Barnes", "PF", 25, "USA", 206, 103, 92, 92, 96, 96, 91, 95, 96, 99, 95, 99, 98, 96, 51, 52000000, 5, false);
        Add(437, "TOR", "Brandon", "Ingram", "SF", 28, "USA", 206, 98, 88, 90, 99, 99, 99, 92, 96, 86, 68, 98, 99, 88, 44, 38000000, 4, false);
        Add(438, "TOR", "Immanuel", "Quickley", "PG", 27, "USA", 188, 86, 86, 88, 99, 99, 99, 97, 99, 78, 60, 94, 97, 86, 38, 25000000, 4, false);
        Add(439, "TOR", "RJ", "Barrett", "SF", 26, "CAN", 201, 100, 84, 86, 97, 97, 91, 86, 89, 86, 70, 93, 95, 88, 32, 20000000, 3, false);
        Add(440, "TOR", "Jakob", "Poeltl", "C", 30, "AUT", 213, 114, 84, 82, 79, 85, 59, 79, 81, 97, 98, 95, 93, 61, 97, 16000000, 2, false);
        Add(441, "TOR", "Gradey", "Dick", "SG", 23, "USA", 198, 90, 82, 86, 96, 99, 99, 86, 92, 78, 60, 88, 96, 76, 32, 8000000, 4, false);
        Add(442, "TOR", "Ja'Kobe", "Walter", "SG", 21, "USA", 196, 92, 80, 86, 94, 92, 90, 83, 87, 81, 61, 88, 90, 83, 31, 6000000, 4, false);
        Add(443, "TOR", "Jamal", "Shead", "PG", 24, "CAN", 183, 84, 78, 82, 95, 87, 86, 95, 93, 70, 52, 86, 87, 82, 25, 3000000, 3, false);
        Add(444, "TOR", "Jonathan", "Mogbo", "PF", 23, "USA", 203, 102, 78, 84, 88, 82, 74, 78, 80, 91, 78, 90, 86, 86, 25, 2500000, 4, false);
        Add(445, "TOR", "Collin", "Murray-Boyles", "PF", 22, "USA", 203, 104, 78, 86, 86, 82, 72, 78, 80, 89, 80, 91, 86, 88, 26, 3000000, 4, false);
        Add(446, "TOR", "Trayce", "Jackson-Davis", "C", 26, "USA", 206, 111, 80, 84, 82, 84, 56, 72, 74, 91, 93, 90, 88, 58, 92, 5000000, 3, false);
        Add(447, "TOR", "Sandro", "Mamukelashvili", "PF", 27, "GEO", 208, 104, 78, 80, 82, 88, 84, 80, 84, 86, 80, 84, 86, 78, 26, 4000000, 2, false);
        Add(448, "TOR", "A.J.", "Lawson", "SG", 26, "CAN", 196, 90, 76, 80, 93, 83, 81, 79, 81, 83, 62, 85, 83, 81, 25, 2000000, 2, false);
        Add(449, "TOR", "Jamison", "Battle", "SF", 25, "USA", 198, 95, 76, 82, 87, 87, 90, 77, 81, 79, 61, 83, 85, 81, 25, 2000000, 3, false);
        Add(450, "TOR", "Allen", "Graves", "SF", 22, "USA", 203, 100, 65, 76, 80, 72, 72, 74, 76, 84, 74, 80, 80, 74, 56, 4_200_000, 4, true);
        Add(451, "TOR", "Jaden", "Bradley", "PG", 22, "USA", 188, 84, 57, 66, 82, 76, 70, 80, 76, 78, 52, 80, 78, 76, 40, 2_000_000, 2, true);

        // ── UTA ──
        Add(452, "UTA", "Lauri", "Markkanen", "PF", 29, "FIN", 213, 109, 90, 92, 99, 99, 99, 94, 99, 92, 76, 97, 99, 90, 46, 42000000, 4, false);
        Add(453, "UTA", "Jaren", "Jackson Jr.", "PF", 27, "USA", 211, 110, 92, 90, 88, 92, 86, 82, 86, 99, 99, 97, 96, 88, 99, 48000000, 5, false);
        Add(454, "UTA", "Walker", "Kessler", "C", 25, "USA", 213, 118, 84, 80, 76, 85, 44, 72, 76, 99, 99, 99, 99, 76, 99, 18000000, 4, false);
        Add(455, "UTA", "Jusuf", "Nurkic", "C", 31, "BIH", 213, 127, 82, 78, 69, 85, 52, 77, 81, 93, 97, 93, 95, 63, 97, 16000000, 2, false);
        Add(456, "UTA", "Keyonte", "George", "PG", 22, "USA", 193, 88, 84, 88, 99, 98, 94, 96, 97, 76, 58, 92, 94, 86, 34, 8000000, 4, false);
        Add(457, "UTA", "Isaiah", "Collier", "PG", 21, "USA", 193, 92, 82, 90, 99, 92, 86, 93, 93, 78, 60, 90, 91, 86, 34, 7000000, 4, false);
        Add(458, "UTA", "Ace", "Bailey", "SF", 19, "USA", 203, 96, 84, 94, 98, 94, 90, 85, 89, 87, 71, 92, 90, 89, 39, 9000000, 5, false);
        Add(459, "UTA", "Brice", "Sensabaugh", "SF", 22, "USA", 201, 102, 80, 86, 94, 98, 99, 82, 88, 76, 59, 86, 92, 75, 31, 4000000, 4, false);
        Add(460, "UTA", "Cody", "Williams", "SF", 21, "USA", 203, 95, 78, 88, 92, 86, 82, 78, 82, 86, 66, 88, 86, 86, 26, 5000000, 4, false);
        Add(461, "UTA", "Kyle", "Filipowski", "PF", 22, "USA", 211, 110, 82, 86, 79, 86, 82, 77, 81, 84, 82, 84, 86, 75, 86, 6000000, 4, false);
        Add(462, "UTA", "Oscar", "Tshiebwe", "C", 25, "COD", 206, 120, 78, 78, 70, 79, 30, 70, 72, 95, 99, 93, 91, 62, 97, 3000000, 3, false);
        Add(463, "UTA", "Kevin", "Love", "PF", 37, "USA", 203, 113, 78, 76, 71, 88, 89, 85, 89, 81, 79, 81, 89, 73, 33, 8000000, 1, false);
        Add(464, "UTA", "Svi", "Mykhailiuk", "SG", 28, "UKR", 201, 92, 78, 80, 93, 93, 97, 83, 87, 73, 57, 85, 91, 73, 26, 5000000, 2, false);
        Add(465, "UTA", "John", "Konchar", "SG", 30, "USA", 196, 95, 78, 78, 85, 81, 81, 83, 85, 89, 68, 87, 85, 89, 25, 6000000, 2, false);
        Add(466, "UTA", "Darryn", "Peterson", "SG", 19, "USA", 196, 98, 80, 94, 91, 91, 88, 84, 92, 85, 66, 93, 85, 80, 55, 10_500_000, 4, true);

        // ── WAS ──
        Add(467, "WAS", "Trae", "Young", "PG", 27, "USA", 185, 82, 94, 94, 99, 99, 99, 99, 99, 96, 78, 99, 99, 99, 68, 52000000, 5, false);
        Add(468, "WAS", "D'Angelo", "Russell", "PG", 30, "USA", 193, 88, 84, 86, 97, 98, 99, 97, 99, 75, 59, 89, 95, 83, 33, 25000000, 2, false);
        Add(469, "WAS", "Anthony", "Davis", "PF", 33, "USA", 208, 115, 92, 90, 84, 91, 78, 88, 90, 99, 99, 97, 97, 90, 99, 50000000, 4, false);
        Add(470, "WAS", "Alex", "Sarr", "C", 21, "FRA", 213, 100, 86, 92, 83, 85, 75, 79, 81, 90, 94, 91, 89, 85, 94, 12000000, 5, false);
        Add(471, "WAS", "Bilal", "Coulibaly", "SF", 22, "FRA", 201, 95, 84, 90, 95, 89, 84, 85, 87, 95, 78, 95, 91, 93, 32, 9000000, 4, false);
        Add(472, "WAS", "Cam", "Whitmore", "SF", 22, "USA", 198, 100, 86, 92, 98, 98, 92, 86, 90, 92, 70, 96, 94, 92, 38, 8000000, 4, false);
        Add(473, "WAS", "Jaden", "Hardy", "SG", 23, "USA", 193, 90, 82, 88, 99, 99, 95, 88, 91, 76, 60, 89, 93, 80, 32, 6000000, 3, false);
        Add(474, "WAS", "Tre", "Johnson", "SG", 20, "USA", 196, 88, 82, 90, 99, 96, 98, 85, 88, 77, 61, 90, 92, 83, 33, 5000000, 4, false);
        Add(475, "WAS", "Kyshawn", "George", "SF", 21, "CAN", 203, 94, 80, 88, 92, 88, 90, 82, 86, 86, 66, 88, 86, 88, 28, 5000000, 4, false);
        Add(476, "WAS", "Will", "Riley", "SF", 20, "USA", 201, 92, 78, 88, 94, 86, 88, 80, 84, 82, 63, 86, 84, 84, 27, 4000000, 4, false);
        Add(477, "WAS", "Bub", "Carrington", "PG", 21, "USA", 193, 86, 78, 86, 97, 89, 85, 89, 91, 72, 54, 85, 87, 81, 28, 4000000, 4, false);
        Add(478, "WAS", "Sharife", "Cooper", "PG", 25, "USA", 183, 82, 74, 84, 94, 84, 81, 88, 86, 67, 49, 81, 82, 77, 25, 2000000, 2, false);
        Add(479, "WAS", "Justin", "Champagnie", "SF", 25, "USA", 198, 95, 78, 82, 88, 86, 84, 78, 82, 89, 68, 88, 84, 86, 25, 3000000, 2, false);
        Add(480, "WAS", "Anthony", "Gill", "PF", 32, "USA", 203, 104, 76, 78, 78, 82, 80, 76, 80, 88, 75, 86, 84, 82, 25, 4000000, 1, false);
        Add(481, "WAS", "Tristan", "Vukcevic", "C", 22, "SRB", 213, 108, 80, 86, 76, 85, 82, 74, 78, 80, 82, 82, 84, 72, 85, 5000000, 4, false);
        Add(482, "WAS", "AJ", "Dybantsa", "SF", 19, "USA", 206, 95, 82, 95, 93, 88, 78, 82, 90, 82, 72, 97, 83, 75, 52, 13_500_000, 4, true);
        Add(483, "WAS", "Felix", "Okpara", "C", 22, "NGA", 213, 107, 58, 70, 72, 56, 38, 60, 56, 76, 92, 78, 72, 64, 88, 2_000_000, 2, true);
    ...
    public void SeedFreeAgents()
    {
        ...
        // ── Free Agents ──
        AddFA(484, "Tyson", "Etienne", "SG", 26, "USA", 188, 86, 76, 82, 84, 78, 74, 76, 72, 60, 44, 74, 76, 70, 10, 2000000, 2);
        AddFA(485, "Chaney", "Johnson", "PF", 24, "USA", 201, 98, 74, 82, 78, 76, 70, 72, 74, 80, 62, 78, 76, 74, 10, 2000000, 2);
        AddFA(486, "Trevon", "Scott", "SF", 27, "USA", 198, 95, 74, 80, 78, 74, 70, 72, 74, 76, 56, 76, 74, 72, 8, 1500000, 1);
        AddFA(487, "Malachi", "Smith", "PG", 25, "USA", 185, 82, 76, 84, 84, 78, 76, 80, 78, 60, 42, 74, 76, 70, 10, 2000000, 2);
        AddFA(488, "Tosan", "Evbuomwan", "SF", 24, "GBR", 201, 95, 76, 82, 80, 76, 72, 74, 76, 78, 58, 78, 76, 76, 10, 2000000, 2);
        AddFA(489, "Sion", "James", "SG", 23, "USA", 196, 92, 76, 84, 82, 76, 74, 74, 76, 74, 52, 76, 74, 74, 10, 2000000, 2);
        AddFA(490, "Antonio", "Reeves", "SG", 24, "USA", 193, 90, 78, 86, 80, 82, 84, 70, 74, 60, 44, 74, 78, 68, 12, 2500000, 3);
        AddFA(491, "PJ", "Hall", "PF", 24, "USA", 206, 110, 78, 84, 76, 78, 70, 72, 74, 82, 70, 80, 78, 78, 14, 3000000, 3);
        AddFA(492, "Mouhamadou", "Gueye", "PF", 26, "USA", 208, 102, 74, 82, 78, 72, 64, 70, 72, 82, 74, 82, 76, 80, 10, 2000000, 2);
        AddFA(493, "Yuki", "Kawamura", "PG", 23, "JPN", 173, 72, 74, 84, 88, 74, 76, 82, 80, 56, 36, 74, 74, 68, 10, 2000000, 2);
        AddFA(494, "Mac", "McClung", "SG", 26, "USA", 188, 84, 76, 86, 90, 78, 80, 80, 78, 58, 40, 76, 76, 72, 10, 2000000, 1);
        AddFA(495, "Lachlan", "Olbrich", "PF", 24, "AUS", 206, 104, 72, 80, 74, 72, 66, 70, 72, 80, 72, 78, 74, 76, 8, 1500000, 2);
        AddFA(496, "Olivier", "Sarr", "C", 26, "FRA", 213, 108, 78, 84, 70, 78, 70, 70, 74, 82, 80, 80, 78, 82, 14, 3000000, 2);
        AddFA(497, "Tristan", "Enaruna", "SF", 25, "USA", 203, 98, 74, 82, 78, 74, 70, 72, 74, 78, 60, 78, 76, 76, 10, 2000000, 2);
        AddFA(498, "Riley", "Minix", "SF", 24, "USA", 198, 94, 74, 82, 80, 74, 72, 72, 74, 76, 58, 76, 74, 74, 10, 2000000, 2);
        AddFA(499, "Nae'Qwan", "Tomlin", "PF", 25, "USA", 206, 104, 74, 82, 78, 72, 66, 70, 72, 80, 70, 80, 76, 78, 10, 2000000, 2);
        AddFA(500, "Dwight", "Powell", "C", 34, "CAN", 208, 108, 76, 78, 68, 74, 60, 72, 74, 82, 82, 80, 78, 84, 8, 4000000, 1);
        AddFA(501, "Moussa", "Cisse", "C", 23, "MLI", 211, 102, 74, 82, 70, 70, 40, 60, 62, 84, 86, 82, 80, 86, 10, 2000000, 2);
        AddFA(502, "John", "Poulakidas", "SG", 24, "USA", 198, 92, 74, 82, 76, 78, 80, 72, 74, 70, 50, 74, 74, 72, 10, 2000000, 2);
        AddFA(503, "Spencer", "Jones", "SF", 24, "USA", 206, 100, 74, 82, 78, 78, 80, 72, 74, 76, 58, 76, 76, 74, 10, 2000000, 2);
        AddFA(504, "Curtis", "Jones", "SG", 25, "USA", 193, 90, 76, 84, 84, 78, 76, 78, 76, 60, 44, 74, 76, 72, 10, 2000000, 2);
        AddFA(505, "KJ", "Simpson", "PG", 23, "USA", 185, 84, 78, 86, 88, 80, 78, 82, 80, 58, 40, 76, 76, 74, 12, 2500000, 3);
        AddFA(506, "Isaac", "Jones", "PF", 25, "USA", 206, 102, 76, 84, 78, 74, 66, 70, 72, 82, 72, 82, 78, 80, 10, 2000000, 2);
        AddFA(507, "Daniss", "Jenkins", "PG", 24, "USA", 188, 84, 76, 84, 86, 78, 76, 80, 78, 60, 42, 74, 76, 72, 10, 2000000, 2);
        AddFA(508, "Tolu", "Smith", "C", 24, "USA", 208, 112, 76, 84, 70, 74, 50, 66, 68, 84, 86, 82, 80, 84, 10, 2000000, 2);
        AddFA(509, "Will", "Richard", "SG", 23, "USA", 196, 92, 76, 84, 82, 78, 76, 74, 76, 74, 54, 76, 76, 74, 10, 2000000, 2);
        AddFA(510, "LJ", "Cryer", "SG", 24, "USA", 193, 88, 78, 86, 80, 82, 84, 72, 74, 60, 44, 74, 78, 68, 12, 2500000, 3);
        AddFA(511, "Malevy", "Leons", "PF", 25, "NED", 206, 100, 74, 82, 76, 74, 70, 72, 74, 82, 70, 80, 76, 80, 10, 2000000, 2);
        AddFA(512, "Pat", "Spencer", "SG", 29, "USA", 196, 95, 74, 80, 82, 76, 78, 78, 80, 72, 50, 78, 76, 78, 8, 1500000, 1);
        AddFA(513, "Nate", "Williams", "SG", 26, "USA", 196, 92, 74, 80, 84, 76, 74, 74, 76, 74, 52, 76, 74, 74, 8, 1500000, 1);
        AddFA(514, "Keshon", "Gilbert", "PG", 23, "USA", 185, 84, 76, 84, 86, 78, 76, 80, 78, 58, 40, 74, 76, 72, 10, 2000000, 2);
        AddFA(515, "JD", "Davison", "PG", 23, "USA", 183, 82, 78, 86, 90, 78, 76, 82, 80, 60, 42, 76, 76, 74, 12, 2500000, 3);
        AddFA(516, "Isaiah", "Crawford", "SF", 24, "USA", 198, 94, 74, 82, 78, 74, 72, 72, 74, 78, 58, 78, 76, 76, 10, 2000000, 2);
        AddFA(517, "Jalen", "Slawson", "SF", 25, "USA", 201, 98, 74, 82, 80, 74, 72, 72, 74, 80, 60, 80, 76, 78, 10, 2000000, 2);
        ...
        AddFA(520, "Ethan", "Thompson", "SG", 25, "USA", 196, 92, 74, 80, 82, 76, 74, 72, 74, 74, 52, 76, 74, 74, 8, 1500000, 2);
        ...
        AddFA(523, "Yanic", "Konan Niederhauser", "C", 23, "SUI", 213, 108, 78, 86, 72, 76, 60, 68, 72, 84, 82, 82, 80, 86, 12, 2500000, 3);
        AddFA(524, "Norchad", "Omier", "PF", 24, "NCA", 203, 104, 78, 86, 78, 74, 66, 70, 72, 84, 74, 82, 78, 80, 12, 2500000, 3);
        AddFA(525, "Sean", "Pedulla", "PG", 23, "USA", 183, 82, 76, 84, 86, 78, 76, 80, 78, 58, 40, 74, 76, 72, 10, 2000000, 2);
        ...
        AddFA(530, "Adama", "Bal", "SG", 23, "FRA", 198, 92, 76, 84, 82, 76, 74, 72, 74, 74, 52, 76, 74, 74, 10, 2000000, 2);
        AddFA(531, "Toby", "Okani", "SF", 24, "USA", 201, 96, 74, 82, 80, 74, 72, 72, 74, 78, 60, 78, 76, 76, 10, 2000000, 2);
        AddFA(532, "Lucas", "Williamson", "SG", 26, "USA", 196, 92, 74, 80, 78, 74, 72, 72, 74, 76, 54, 76, 74, 74, 8, 1500000, 1);
        ...
        AddFA(535, "Jahmir", "Young", "PG", 24, "USA", 183, 82, 76, 84, 86, 78, 76, 80, 78, 58, 40, 74, 76, 72, 10, 2000000, 2);
        AddFA(536, "Vladislav", "Goldin", "C", 24, "RUS", 216, 112, 78, 84, 68, 76, 60, 70, 72, 84, 86, 82, 80, 86, 12, 2500000, 3);
        AddFA(537, "Myron", "Gardner", "PF", 25, "USA", 206, 102, 74, 82, 78, 74, 66, 70, 72, 82, 74, 80, 76, 78, 10, 2000000, 2);
        AddFA(538, "Zyon", "Pullin", "PG", 23, "USA", 183, 82, 76, 84, 86, 78, 76, 80, 78, 58, 40, 74, 76, 72, 10, 2000000, 2);
        AddFA(539, "Julian", "Phillips", "SF", 22, "USA", 201, 94, 80, 88, 84, 80, 78, 76, 78, 80, 60, 80, 78, 80, 16, 3000000, 3);
        AddFA(540, "Rocco", "Zikarsky", "C", 19, "AUS", 218, 115, 78, 90, 60, 70, 40, 62, 66, 86, 88, 84, 82, 90, 14, 4000000, 4);
        AddFA(541, "Joan", "Beringer", "C", 20, "FRA", 211, 104, 78, 88, 70, 72, 50, 64, 68, 84, 86, 82, 80, 88, 14, 3000000, 4);
        AddFA(542, "Enrique", "Freeman", "PF", 24, "USA", 203, 102, 76, 84, 78, 74, 66, 70, 72, 82, 74, 80, 76, 78, 10, 2000000, 2);
        AddFA(543, "Cormac", "Ryan", "SG", 26, "USA", 196, 92, 76, 84, 80, 78, 80, 72, 74, 74, 52, 76, 76, 74, 10, 2000000, 2);
        AddFA(544, "Alex", "Antetokounmpo", "SF", 24, "GRE", 203, 95, 74, 84, 84, 74, 70, 72, 74, 78, 60, 80, 76, 78, 10, 2000000, 2);
        AddFA(545, "Trey", "Jemison III", "C", 25, "USA", 208, 110, 76, 82, 68, 74, 50, 66, 68, 84, 86, 82, 80, 84, 10, 2000000, 2);
        AddFA(546, "Dillon", "Jones", "SF", 23, "USA", 198, 94, 76, 84, 82, 76, 74, 72, 74, 78, 58, 78, 76, 76, 10, 2000000, 2);
        AddFA(547, "Mohamed", "Diawara", "SF", 22, "FRA", 201, 92, 76, 84, 80, 74, 72, 72, 74, 78, 56, 78, 76, 76, 10, 2000000, 2);
        AddFA(548, "Micah", "Peavy", "SG", 23, "USA", 196, 92, 76, 84, 84, 76, 74, 74, 76, 74, 52, 76, 74, 74, 10, 2000000, 2);
        AddFA(549, "Josh", "Oduro", "PF", 24, "USA", 203, 104, 76, 84, 76, 74, 66, 70, 72, 82, 74, 80, 76, 78, 10, 2000000, 2);
        AddFA(550, "Karlo", "Matkovic", "PF", 24, "CRO", 208, 104, 78, 86, 78, 76, 66, 72, 74, 84, 78, 82, 80, 82, 12, 2500000, 3);
        AddFA(551, "Colin", "Castleton", "C", 25, "USA", 211, 112, 78, 84, 70, 76, 50, 68, 70, 84, 86, 82, 80, 84, 12, 2500000, 3);
        AddFA(552, "Jase", "Richardson", "SG", 19, "USA", 196, 88, 73, 70, 76, 72, 70, 76, 78, 74, 54, 80, 78, 78, 18, 5000000, 4);
        AddFA(553, "Noah", "Penda", "SF", 21, "FRA", 201, 94, 78, 88, 84, 78, 76, 74, 76, 78, 58, 80, 78, 78, 16, 3000000, 4);
        AddFA(554, "Alex", "Morales", "SG", 24, "USA", 193, 88, 74, 80, 82, 74, 72, 72, 74, 74, 50, 76, 74, 74, 8, 1500000, 2);
        AddFA(555, "Brooks", "Barnhizer", "SF", 23, "USA", 198, 94, 78, 84, 82, 78, 74, 74, 76, 80, 60, 80, 78, 80, 14, 2500000, 3);
        AddFA(556, "Branden", "Carlson", "C", 25, "USA", 213, 112, 78, 84, 68, 76, 60, 70, 72, 84, 86, 82, 80, 84, 12, 2500000, 3);
        AddFA(557, "Payton", "Sandfort", "SF", 22, "USA", 201, 94, 70, 76, 78, 72, 76, 74, 76, 72, 54, 78, 78, 76, 14, 2500000, 3);
        AddFA(558, "Thomas", "Sorber", "C", 19, "USA", 211, 110, 72, 80, 60, 68, 60, 62, 74, 76, 78, 74, 72, 78, 18, 5000000, 4);
        AddFA(559, "Emoni", "Bates", "SF", 22, "USA", 207, 92, 76, 84, 84, 76, 74, 74, 76, 74, 52, 76, 74, 74, 10, 2000000, 2);
        AddFA(560, "Koby", "Brea", "SG", 24, "USA", 196, 90, 78, 86, 80, 84, 86, 72, 74, 60, 44, 74, 78, 68, 12, 2500000, 3);
        AddFA(561, "Rasheer", "Fleming", "PF", 22, "USA", 206, 102, 72, 86, 78, 80, 74, 74, 76, 82, 72, 82, 80, 80, 16, 3000000, 3);
        AddFA(562, "Isaiah", "Livers", "PF", 27, "USA", 203, 102, 76, 82, 76, 80, 80, 72, 74, 78, 62, 78, 76, 76, 10, 2000000, 2);
        AddFA(563, "CJ", "Huntley", "PF", 25, "USA", 206, 104, 74, 82, 76, 74, 66, 70, 72, 82, 74, 80, 76, 78, 10, 2000000, 2);
        AddFA(564, "Jamaree", "Bouyea", "PG", 26, "USA", 183, 82, 76, 84, 86, 78, 76, 80, 78, 58, 40, 74, 76, 72, 10, 2000000, 2);
        AddFA(565, "Haywood", "Highsmith", "SF", 28, "USA", 198, 95, 78, 82, 82, 78, 76, 74, 76, 82, 60, 80, 78, 80, 10, 2000000, 2);
        AddFA(566, "Dalen", "Terry", "SG", 23, "USA", 198, 92, 78, 84, 84, 78, 76, 74, 76, 78, 56, 78, 76, 76, 12, 2500000, 3);
        AddFA(567, "Jabari", "Walker", "PF", 23, "USA", 206, 104, 78, 86, 80, 78, 74, 74, 76, 82, 70, 82, 78, 80, 14, 3000000, 3);
        AddFA(568, "Tyrese", "Martin", "SG", 26, "USA", 196, 92, 76, 82, 82, 76, 74, 74, 76, 74, 52, 76, 74, 74, 10, 2000000, 2);
        AddFA(569, "Isaiah", "Stevens", "PG", 25, "USA", 183, 82, 76, 84, 86, 78, 76, 80, 78, 58, 40, 74, 76, 72, 10, 2000000, 2);
        AddFA(570, "Dylan", "Cardwell", "C", 24, "USA", 208, 110, 76, 82, 68, 74, 50, 66, 68, 84, 86, 82, 80, 84, 10, 2000000, 2);
        AddFA(571, "Nique", "Clifford", "SF", 24, "USA", 198, 94, 78, 84, 82, 78, 74, 74, 76, 80, 60, 80, 78, 80, 14, 2500000, 3);
        AddFA(572, "Daeqwon", "Plowden", "SG", 26, "USA", 196, 92, 76, 82, 82, 76, 74, 74, 76, 74, 52, 76, 74, 74, 10, 2000000, 2);
        AddFA(573, "Chris", "Youngblood", "SG", 24, "USA", 196, 92, 76, 82, 82, 76, 74, 74, 76, 74, 52, 76, 74, 74, 10, 2000000, 2);
        AddFA(574, "Sidy", "Cissoko", "SF", 21, "FRA", 201, 94, 77, 88, 84, 80, 76, 74, 76, 80, 60, 80, 78, 80, 16, 3000000, 4);
        AddFA(575, "Jayson", "Kent", "SF", 23, "USA", 198, 94, 76, 84, 82, 76, 74, 74, 76, 78, 58, 78, 76, 76, 10, 2000000, 2);
        AddFA(576, "Yang", "Hansen", "C", 19, "CHN", 218, 115, 80, 90, 60, 78, 60, 72, 74, 86, 88, 84, 82, 88, 18, 5000000, 4);
        AddFA(577, "Garrett", "Temple", "SG", 39, "USA", 196, 88, 74, 72, 70, 72, 72, 78, 80, 76, 50, 78, 74, 76, 6, 3000000, 1);
        AddFA(578, "Alijah", "Martin", "SG", 22, "USA", 193, 88, 76, 84, 84, 76, 74, 74, 76, 74, 52, 76, 74, 74, 10, 2000000, 2);
        AddFA(579, "Emanuel", "Miller", "PF", 24, "USA", 203, 100, 78, 84, 78, 76, 70, 72, 74, 80, 62, 80, 78, 78, 14, 2500000, 3);
        AddFA(580, "Jordan", "McLaughlin", "PG", 29, "USA", 183, 82, 78, 82, 84, 78, 76, 82, 80, 58, 40, 74, 76, 72, 10, 2000000, 2);
        AddFA(581, "Lindy", "Waters III", "SG", 28, "USA", 196, 92, 78, 84, 82, 80, 84, 72, 74, 74, 52, 76, 76, 74, 10, 2000000, 2);
        AddFA(582, "Carter", "Bryant", "SF", 20, "USA", 206, 96, 78, 88, 74, 72, 78, 74, 76, 70, 60, 82, 80, 82, 18, 5000000, 4);
        AddFA(583, "David", "Jones Garcia", "SF", 23, "ESP", 198, 94, 78, 86, 82, 78, 76, 74, 76, 78, 58, 80, 78, 78, 14, 2500000, 3);
        AddFA(584, "Chucky", "Hepburn", "PG", 22, "USA", 185, 84, 78, 86, 88, 80, 78, 82, 80, 58, 40, 76, 76, 74, 12, 2500000, 3);
        AddFA(585, "Julian", "Reese", "PF", 22, "USA", 206, 104, 78, 84, 76, 78, 66, 70, 72, 82, 74, 82, 78, 80, 14, 2500000, 3);
        AddFA(586, "Leaky", "Black", "SG", 26, "USA", 196, 92, 76, 78, 82, 74, 70, 74, 76, 84, 58, 84, 76, 82, 8, 2000000, 2);
        AddFA(587, "Jamir", "Watkins", "SF", 23, "USA", 198, 95, 78, 84, 84, 78, 74, 74, 76, 80, 60, 80, 78, 78, 14, 2500000, 3);
        AddFA(588, "Kennedy", "Chandler", "PG", 23, "USA", 183, 82, 76, 84, 88, 78, 76, 82, 80, 58, 40, 74, 76, 72, 10, 2000000, 2);
        AddFA(589, "Hayden", "Gray", "SG", 24, "USA", 196, 90, 74, 82, 82, 74, 72, 72, 74, 74, 50, 76, 74, 74, 8, 1500000, 2);
        AddFA(590, "Elijah", "Harkless", "SF", 25, "USA", 198, 94, 76, 82, 80, 76, 72, 74, 76, 80, 58, 80, 76, 78, 10, 2000000, 2);
        AddFA(591, "Blake", "Hinson", "SF", 25, "USA", 201, 100, 76, 84, 78, 82, 84, 72, 74, 70, 52, 76, 76, 74, 10, 2000000, 2);
        AddFA(592, "Bez", "Mbeng", "PG", 23, "CMR", 188, 84, 76, 84, 86, 78, 76, 80, 78, 58, 40, 74, 76, 72, 10, 2000000, 2);
        AddFA(593, "Justin", "Jackson", "SG", 26, "USA", 196, 92, 76, 82, 82, 76, 74, 74, 76, 74, 52, 76, 74, 74, 10, 2000000, 2);
        AddFA(594, "Dante", "Exum", "PG", 30, "AUS", 196, 90, 74, 76, 82, 68, 58, 76, 74, 72, 50, 64, 72, 66, 22, 3000000, 1);
        AddFA(595, "Lonzo", "Ball", "PG", 27, "USA", 198, 86, 70, 74, 78, 64, 60, 74, 70, 70, 56, 64, 70, 68, 30, 2000000, 1);
        AddFA(596, "Patrick", "Beverley", "PG", 38, "USA", 185, 81, 68, 66, 76, 62, 56, 68, 64, 70, 56, 60, 70, 68, 42, 2000000, 1);
        AddFA(597, "Monte", "Morris", "PG", 30, "USA", 188, 83, 72, 74, 78, 66, 58, 76, 74, 68, 50, 62, 72, 62, 22, 2000000, 1);
        AddFA(598, "Ish", "Smith", "PG", 37, "USA", 183, 79, 64, 64, 80, 62, 48, 72, 70, 70, 48, 60, 70, 60, 32, 2000000, 1);
        AddFA(599, "Cameron", "Payne", "PG", 31, "USA", 188, 84, 68, 70, 80, 68, 58, 72, 70, 64, 48, 60, 68, 54, 22, 2000000, 1);
        AddFA(600, "Wesley", "Matthews", "PG", 38, "USA", 193, 95, 62, 62, 72, 62, 58, 60, 60, 62, 52, 56, 64, 50, 30, 2000000, 1);
        AddFA(601, "Malik", "Beasley", "SG", 29, "USA", 193, 84, 76, 77, 78, 80, 88, 62, 74, 62, 52, 75, 70, 64, 32, 8000000, 1);
        AddFA(602, "Cam", "Thomas", "SG", 23, "USA", 196, 93, 84, 92, 76, 88, 84, 68, 80, 70, 60, 72, 82, 69, 36, 10000000, 3);
        AddFA(603, "Ben", "Simmons", "PG", 28, "AUS", 208, 99, 78, 76, 88, 60, 44, 84, 80, 84, 72, 88, 78, 82, 30, 8000000, 2);
        AddFA(604, "Lonnie", "Walker", "SG", 26, "USA", 196, 93, 72, 76, 84, 74, 72, 64, 70, 58, 50, 60, 70, 50, 24, 2000000, 1);
        AddFA(605, "Terrence", "Ross", "SG", 34, "USA", 198, 93, 72, 72, 80, 78, 80, 62, 68, 56, 50, 60, 70, 48, 22, 2000000, 1);
        AddFA(606, "Josh", "Richardson", "SG", 32, "USA", 198, 95, 72, 72, 80, 74, 72, 68, 70, 60, 54, 62, 72, 56, 30, 2000000, 1);
        AddFA(607, "Timothé", "Luwawu-Cabarrot", "SG", 28, "FRA", 198, 93, 68, 72, 80, 72, 68, 64, 66, 58, 52, 58, 68, 50, 20, 2000000, 1);
        AddFA(608, "Reggie", "Bullock", "SG", 33, "USA", 198, 95, 70, 70, 78, 76, 80, 62, 66, 56, 52, 60, 70, 48, 20, 2000000, 1);
        AddFA(609, "Glenn", "Robinson", "SG", 30, "USA", 198, 100, 68, 72, 80, 72, 68, 62, 66, 58, 54, 58, 68, 50, 26, 2000000, 1);
        AddFA(610, "Alec", "Burks", "SG", 33, "USA", 198, 97, 72, 72, 78, 76, 74, 66, 70, 58, 52, 62, 72, 52, 22, 5000000, 1);
        AddFA(611, "Cedi", "Osman", "SG", 30, "TUR", 201, 95, 68, 70, 76, 72, 72, 66, 68, 58, 54, 60, 68, 50, 18, 2000000, 1);
        AddFA(612, "Troy", "Brown", "SG", 26, "USA", 198, 95, 66, 72, 74, 64, 56, 66, 66, 64, 56, 58, 66, 54, 28, 2000000, 1);
        AddFA(613, "Jaden", "Ivey", "SG", 24, "USA", 190, 88, 79, 87, 88, 72, 74, 80, 86, 68, 58, 87, 72, 75, 45, 14000000, 1);
        AddFA(614, "Talen", "Horton-Tucker", "SG", 24, "USA", 196, 93, 72, 74, 78, 66, 56, 60, 60, 62, 54, 64, 60, 59, 30, 11500000, 2);
        AddFA(615, "Hamidou", "Diallo", "SG", 26, "USA", 196, 99, 70, 74, 86, 66, 50, 58, 64, 60, 62, 58, 68, 56, 36, 2000000, 1);
        AddFA(616, "Tony", "Snell", "SG", 33, "USA", 198, 97, 64, 64, 74, 70, 74, 58, 62, 54, 50, 58, 66, 42, 16, 2000000, 1);
        AddFA(617, "Rodney", "McGruder", "SG", 33, "USA", 193, 95, 64, 64, 74, 66, 62, 58, 62, 54, 50, 58, 66, 46, 20, 2000000, 1);
        AddFA(618, "Juan", "Hernangomez", "SG", 30, "ESP", 198, 95, 66, 70, 74, 70, 68, 60, 64, 56, 58, 60, 66, 48, 20, 2000000, 1);
        AddFA(619, "Oshae", "Brissett", "SF", 26, "CAN", 203, 95, 72, 76, 78, 72, 66, 64, 68, 62, 60, 62, 70, 56, 30, 2000000, 1);
        AddFA(620, "Bojan", "Bogdanovic", "SF", 36, "CRO", 203, 104, 76, 76, 74, 82, 84, 68, 70, 56, 50, 60, 76, 48, 22, 19000000, 2);
        AddFA(621, "Justise", "Winslow", "SF", 29, "USA", 198, 104, 66, 72, 74, 58, 42, 68, 68, 66, 62, 60, 70, 56, 36, 2000000, 1);
        AddFA(622, "Danuel", "House", "SF", 31, "USA", 198, 95, 68, 70, 76, 72, 68, 62, 64, 56, 54, 60, 68, 48, 22, 2000000, 1);
        AddFA(623, "Rondae", "Hollis-Jefferson", "SF", 30, "USA", 198, 104, 70, 72, 78, 66, 40, 66, 70, 64, 62, 66, 70, 56, 30, 2000000, 1);
        AddFA(624, "Maurice", "Harkless", "SF", 32, "USA", 203, 99, 66, 66, 74, 66, 58, 60, 62, 58, 60, 58, 68, 48, 28, 2000000, 1);
        AddFA(625, "James", "Ennis", "SF", 34, "USA", 198, 99, 66, 66, 76, 66, 60, 60, 62, 56, 54, 58, 66, 48, 24, 2000000, 1);
        AddFA(626, "Justin", "Holiday", "SF", 35, "USA", 198, 95, 66, 66, 74, 70, 68, 62, 64, 56, 54, 58, 66, 48, 28, 2000000, 1);
        AddFA(627, "Maxwell", "Lewis", "SF", 22, "USA", 201, 95, 64, 76, 74, 64, 60, 58, 62, 54, 50, 56, 66, 50, 18, 2000000, 1);
        AddFA(628, "Terquavion", "Smith", "SF", 22, "USA", 193, 86, 66, 76, 82, 68, 62, 64, 70, 56, 48, 58, 68, 50, 20, 2000000, 1);
        AddFA(629, "Chris", "Boucher", "PF", 33, "CAN", 203, 90, 74, 74, 72, 74, 78, 60, 64, 66, 70, 75, 72, 62, 78, 4000000, 1);
        AddFA(630, "Dario", "Saric", "PF", 31, "CRO", 208, 102, 72, 74, 72, 72, 68, 70, 68, 64, 60, 62, 72, 54, 30, 5000000, 1);
        AddFA(631, "Orlando", "Robinson", "PF", 24, "USA", 211, 104, 64, 72, 66, 50, 30, 50, 50, 60, 76, 64, 58, 46, 42, 2000000, 1);
        AddFA(632, "Thaddeus", "Young", "PF", 36, "USA", 203, 100, 68, 68, 72, 64, 40, 64, 68, 62, 64, 62, 70, 54, 56, 2000000, 1);
        AddFA(633, "Noah", "Vonleh", "PF", 29, "USA", 208, 113, 62, 66, 68, 50, 28, 48, 50, 60, 76, 64, 60, 44, 42, 2000000, 1);
        AddFA(634, "JaMychal", "Green", "PF", 34, "USA", 203, 102, 66, 66, 68, 62, 50, 56, 58, 62, 72, 64, 64, 48, 36, 2000000, 1);
        AddFA(635, "Mo", "Bamba", "C", 26, "USA", 213, 104, 70, 76, 68, 58, 46, 52, 54, 62, 80, 70, 60, 42, 70, 2000000, 1);
        AddFA(636, "James", "Wiseman", "C", 24, "USA", 213, 109, 72, 80, 72, 64, 30, 54, 54, 64, 78, 70, 64, 46, 58, 8000000, 2);
        AddFA(637, "Bruno", "Fernando", "C", 26, "ANG", 206, 109, 66, 72, 70, 52, 24, 50, 50, 60, 78, 68, 60, 44, 48, 2000000, 1);
        AddFA(638, "Justin", "Minaya", "C", 26, "USA", 203, 102, 62, 70, 68, 54, 32, 50, 50, 60, 74, 64, 58, 42, 44, 2000000, 1);
        AddFA(639, "Tony", "Bradley", "C", 27, "USA", 211, 113, 66, 72, 68, 56, 24, 48, 48, 60, 76, 66, 60, 42, 50, 2000000, 1);
        AddFA(640, "Boban", "Marjanovic", "C", 36, "SRB", 224, 131, 66, 66, 60, 56, 30, 50, 50, 56, 82, 64, 56, 40, 44, 2000000, 1);
