...
public class DatabaseManager : MonoBehaviour
{
    ...
    void SeedPlayers()
    {
        ...
        Add(483, "ATL", "Jonathan", "Kuminga",          "SF", 22, "COD", 201,  78, 78, 89, 80, 90, 76, 74, 76, 70, 92, 80, 76, 74, 92, 24000000, 1, false);
        ...
        Add(331, "ATL", "Luguentz", "Dort",             "SG", 27, "CAN", 193,  78, 78, 88, 96, 78, 76, 72, 98, 99, 68, 80, 76, 92, 80, 16000000, 3, false);
        ...
        // ── BOS ── 15 jugadores
        // ----------------------------------------------------------------------- OV  PO  VE  2P  3P  PA  DR  DF  RB  AT  IQ  RO  TA
        Add(15, "BOS", "Jayson",    "Tatum",            "PF", 28, "USA", 203,  95, 94, 96, 97, 96, 99, 91, 96, 94, 94, 96, 94, 94, 75, 54100000, 4, false);
        Add(16, "BOS", "Paul",      "George",           "SF", 36, "USA", 206, 100, 86, 87, 89, 91, 89, 87, 84, 84, 74, 96, 91, 87, 68, 35000000, 2, false);
        Add(17, "BOS", "Derrick",   "White",            "PG", 32, "USA", 193,  86, 89, 90, 91, 94, 91, 91, 96, 74, 84, 96, 94, 79, 85, 28100000, 3, false);
        Add(18, "BOS", "Payton",    "Pritchard",        "PG", 28, "USA", 185,  88, 84, 90, 84, 94, 84, 89, 83, 78, 84, 89, 74, 74, 74,  7200000, 3, false);
        Add(19, "BOS", "Sam",       "Hauser",           "SF", 28, "USA", 201,  98, 80, 88, 79, 99, 74, 69, 79, 84, 79, 89, 77, 77, 62, 10000000, 4, false);
        Add(20, "BOS", "Neemias",   "Queta",            "C",  27, "PRT", 213, 111, 81, 84, 79, 59, 74, 74, 91, 94, 84, 84, 89, 89, 65, 11000000, 4, false);
        ...
        // ── BKN ── 16 jugadores
        // ----------------------------------------------------------------------- OV  PO  VE  2P  3P  PA  DR  DF  RB  AT  IQ  RO  TA
        Add(33, "BKN", "Michael",   "Porter Jr.",       "SF", 28, "USA", 208, 99,  85, 90, 94, 99, 89, 84, 74, 89, 84, 89, 74, 85, 82, 38300000, 2, false);
        Add(34, "BKN", "Julius",    "Randle",           "PF", 31, "USA", 203, 113, 87, 90, 94, 84, 94, 84, 79, 99, 89, 89, 74, 92, 58, 33000000, 3, false);
        Add(35, "BKN", "Nic",       "Claxton",          "C",  27, "USA", 211, 98,  80, 88, 89, 54, 49, 55, 99, 99, 94, 74, 84, 99, 85, 25300000, 3, false);
        ...
        Add(60, "CHA", "Tre",       "Mann",             "PG", 25, "USA", 191, 81,  76, 84, 79, 84, 84, 84, 64, 64, 79, 84, 64, 66, 32, 12000000, 3, false);
        ...
        Add(69, "CHA", "Pat",       "Connaughton",      "SG", 33, "USA", 196, 94,  74, 78, 74, 84, 74, 74, 79, 69, 64, 84, 74, 74, 48,  9400000, 1, false);
        ...
        Add(77, "CHI", "Guerschon", "Yabusele",         "PF", 30, "FRA", 203, 118, 79, 72, 69, 84, 64, 79, 59, 84, 74, 84, 74, 69, 78, 12000000, 2, false);
        ...
        // ── CLE ── 13 jugadores
        // ------------------------------------------------------------------------ OV  PO  VE  2P  3P  PA  DR  DF  RB  AT  IQ  RO  TA
        Add(87,  "CLE", "Donovan",   "Mitchell",         "SG", 30, "USA", 191,  97, 94, 96, 94, 94, 92, 91, 90, 86, 82, 99, 97, 96, 92, 68000000, 4, false);
        Add(88,  "CLE", "Evan",      "Mobley",           "PF", 25, "USA", 211,  98, 91, 95, 85, 89, 76, 82, 80, 94, 96, 92, 94, 87, 94, 45000000, 5, false);
        Add(89,  "CLE", "James",     "Harden",           "PG", 37, "USA", 196, 100, 89, 86, 82, 91, 94, 97, 82, 75, 84, 95, 94, 88, 69, 32000000, 2, false);
        Add(90,  "CLE", "Jarrett",   "Allen",            "C",  28, "USA", 206, 110, 87, 86, 83, 89, 55, 78, 73, 97, 97, 90, 91, 82, 98, 30000000, 3, false);
        Add(91,  "CLE", "Max",       "Strus",            "SF", 30, "USA", 196,  97, 81, 84, 79, 80, 89, 78, 75, 79, 68, 80, 83, 72, 67, 16000000, 2, false);
        Add(92,  "CLE", "Dennis",    "Schroder",         "PG", 33, "DEU", 188,  78, 79, 83, 83, 78, 76, 84, 82, 80, 58, 81, 84, 79, 65,  7000000, 1, false);
        ...
        // ── DAL ── 15 jugadores
        // ----------------------------------------------------------------------- OV  PO  VE  2P  3P  PA  DR  DF  RB  AT  IQ  RO  TA
        Add(100, "DAL", "Kyrie",      "Irving",         "PG", 34, "USA", 188,  88, 94, 95, 89, 94, 93, 92, 88, 78, 86, 92, 91, 82, 78, 36500000, 2, false);
        ...
        Add(108, "DAL", "Naji",       "Marshall",       "SF", 28, "USA", 198,  99, 80, 84, 81, 80, 80, 78, 78, 82, 78, 78, 80, 80, 61,  9000000, 2, false);
        ...
        Add(113, "DAL", "Brandon",    "Williams",       "PG", 26, "USA", 188,  86, 73, 83, 80, 76, 79, 77, 73, 56, 69, 71, 71, 69, 50,  2200000, 1, false);
        ...
        // ── DEN ── 15 jugadores
        // ----------------------------------------------------------------------- OV  PO  VE  2P  3P  PA  DR  DF  RB  AT  IQ  RO  TA
        Add(118, "DEN", "Nikola",     "Jokic",          "C",  31, "SRB", 211, 129, 98, 99, 98, 99, 99, 99, 98, 99, 99, 99, 99, 97, 94, 62000000, 4, false);
        Add(119, "DEN", "Jamal",      "Murray",         "PG", 29, "CAN", 193,  98, 90, 94, 91, 95, 93, 92, 91, 86, 88, 94, 92, 84, 73, 50000000, 4, false);
        Add(120, "DEN", "Aaron",      "Gordon",         "PF", 31, "USA", 203, 107, 86, 90, 86, 87, 80, 82, 85, 90, 88, 86, 83, 78, 95, 33000000, 3, false);
        Add(121, "DEN", "Cameron",    "Johnson",        "SF", 30, "USA", 203,  95, 85, 89, 84, 88, 92, 84, 86, 84, 84, 81, 80, 86, 75, 23000000, 2, false);
        Add(122, "DEN", "Christian",  "Braun",          "SG", 25, "USA", 198, 100, 83, 88, 85, 84, 88, 89, 80, 95, 79, 83, 91, 82, 64, 11000000, 4, false);
        ...
        Add(126, "DEN", "Bruce",      "Brown",          "SG", 30, "USA", 193,  92, 82, 82, 83, 83, 78, 80, 79, 85, 78, 80, 82, 80, 62,  6000000, 1, false);
        Add(127, "DEN", "Peyton",     "Watson",         "SF", 23, "USA", 201,  91, 81, 88, 84, 78, 68, 73, 77, 85, 79, 77, 75, 75, 86,  5500000, 3, false);
        ...
        Add(499, "OKC", "Spencer",    "Jones",          "SF", 24, "USA", 206, 100, 79, 80, 74, 87, 71, 71, 79, 81, 81, 81, 81, 84, 74,  6000000, 2, false);
        ...
        // ── DET ── 17 jugadores
        // ----------------------------------------------------------------------- OV  PO  VE  2P  3P  PA  DR  DF  RB  AT  IQ  RO  TA
        Add(135, "DET", "Cade",      "Cunningham",      "PG", 25, "USA", 198, 100, 96, 98, 99, 99, 99, 99, 99, 99, 99, 99, 89, 91, 68, 45000000, 5, false);
        ...
        Add(143, "DET", "Duncan",    "Robinson",        "SG", 32, "USA", 201,  97, 83, 84, 74, 84, 99, 89, 84, 64, 79, 74, 89, 87, 42,  9000000, 2, false);
        ...
        // ── GSW ── 14 jugadores
        // ----------------------------------------------------------------------- OV  PO  VE  2P  3P  PA  DR  DF  RB  AT  IQ  RO  TA
        Add(151, "GSW", "Stephen",   "Curry",           "PG", 38, "USA", 188,  84, 98, 95, 99, 95, 99, 99, 99, 95, 68, 99, 95, 99, 69, 59600000, 2, false);
        ...
        Add(154, "GSW", "Draymond",  "Green",           "PF", 36, "USA", 198, 104, 86, 86, 88, 78, 84, 80, 64, 84, 99, 90, 80, 82, 82, 26000000, 3, false);
        ...
        Add(158, "GSW", "Al",        "Horford",         "C",  40, "DOM", 206, 109, 78, 80, 78, 64, 79, 81, 77, 66, 83, 79, 76, 99, 84,  9000000, 1, false);
        ...
        // ── HOU ── 16 jugadores
        // ----------------------------------------------------------------------- OV  PO  VE  2P  3P  PA  DR  DF  RB  AT  IQ  RO  TA
        Add(166, "HOU", "Kevin",     "Durant",          "SF", 38, "USA", 211, 109, 96, 93, 96, 98, 96, 95, 75, 75, 95, 98, 98, 85, 75, 54700000, 2, false);
        Add(167, "HOU", "Marcus",    "Smart",           "PG", 32, "USA", 193, 100, 81, 81, 79, 79, 79, 80, 79, 88, 79, 69, 84, 86, 59,  7500000, 2, false);
        ...
        Add(170, "HOU", "Fred",      "VanVleet",        "PG", 32, "USA", 183,  89, 84, 88, 82, 82, 84, 88, 86, 82, 82, 82, 90, 85, 81, 44500000, 2, false);
        ...
        // ── IND ── 17 jugadores
        // ----------------------------------------------------------------------- OV  PO  VE  2P  3P  PA  DR  DF  RB  AT  IQ  RO  TA
        Add(182, "IND", "Tyrese",   "Haliburton",       "PG", 26, "USA", 196,  84, 95, 92, 97, 94, 96, 95, 98, 77, 69, 91, 98, 95, 65, 55000000, 5, false);
        Add(183, "IND", "Pascal",   "Siakam",           "PF", 32, "CMR", 203, 104, 86, 90, 89, 83, 91, 79, 85, 83, 87, 88, 92, 82, 82, 52000000, 4, false);
        Add(184, "IND", "Ivica",    "Zubac",            "C",  29, "HRV", 213, 109, 77, 88, 87, 73, 91, 60, 75, 94, 88, 96, 84, 89, 90, 20000000, 3, false);
        Add(185, "IND", "Andrew",   "Nembhard",         "PG", 26, "CAN", 193,  87, 82, 84, 88, 82, 84, 80, 86, 84, 80, 72, 86, 76, 66, 18000000, 4, false);
        Add(186, "IND", "Aaron",    "Nesmith",          "SF", 27, "USA", 198,  98, 80, 84, 88, 80, 80, 84, 78, 72, 84, 74, 80, 78, 70, 16000000, 3, false);
        ...
        Add(190, "IND", "T.J.",     "McConnell",        "PG", 34, "USA", 185,  86, 80, 85, 88, 83, 81, 67, 88, 82, 78, 58, 90, 84, 69, 10000000, 2, false);
        ...
        Add(202, "LAC", "Bennedict", "Mathurin",        "SG", 24, "CAN", 198,  95, 84, 88, 89, 84, 74, 84, 74, 89, 91, 79, 84, 85, 55,  9000000, 2, false);
        Add(203, "LAC", "Brook",     "Lopez",           "C",  38, "USA", 216, 127, 81, 80, 64, 94, 79, 69, 59, 79, 69, 91, 74, 99, 90,  9000000, 1, false);
        ...
        // ── LAL ── 17 jugadores
        // ----------------------------------------------------------------------- OV  PO  VE  2P  3P  PA  DR  DF  RB  AT  IQ  RO  TA
        Add(215, "LAL", "Luka",      "Doncic",          "PG", 27, "SVN", 201, 104, 97, 97, 90, 99, 99, 99, 99, 84, 92, 98, 99, 96, 79, 55000000, 5, false);
        ...
        Add(226, "LAL", "Maxi",      "Kleber",          "PF", 34, "DEU", 208, 109, 75, 80, 70, 75, 74, 67, 74, 73, 73, 71, 75, 55, 72, 11000000, 1, false);
        ...
        // ── MIA ── 12 jugadores
        // ----------------------------------------------------------------------- OV  PO  VE  2P  3P  PA  DR  DF  RB  AT  IQ  RO  TA
        Add(250, "MIA", "Bam",      "Adebayo",          "C",  29, "USA", 206,  78, 80, 90, 76, 98, 72, 78, 80, 90, 90, 90, 92, 99, 90, 51000000, 4, false);
        Add(251, "MIA", "Giannis",  "Antetokounmpo",    "PF", 32, "GRC", 211,  78, 82, 98, 90, 96, 78, 88, 90, 90, 90, 99, 86, 98, 92, 62000000, 4, false);
        Add(252, "MIA", "Andrew",   "Wiggins",          "SF", 31, "CAN", 201,  78, 76, 87, 78, 82, 76, 72, 76, 80, 72, 82, 78, 74, 72, 28000000, 2, false);
        Add(253, "MIA", "Bobby",    "Portis",           "PF", 32, "USA", 208,  78, 72, 82, 70, 84, 76, 68, 66, 72, 94, 76, 80, 64, 98, 13000000, 2, false);
        ...
        Add(263, "MIL", "Tyler",     "Herro",           "SG", 26, "USA", 196,  88, 86, 89, 91, 99, 91, 91, 94, 74, 84, 89, 79, 85, 55, 33000000, 4, false);
        ...
        Add(266, "MIL", "Myles",     "Turner",          "C",  30, "USA", 211, 113, 81, 84, 89, 94, 64, 69, 94, 94, 84, 91, 79, 74, 98, 32000000, 4, false);
        ...
        // ── MIN ── 13 jugadores
        // ----------------------------------------------------------------------- OV  PO  VE  2P  3P  PA  DR  DF  RB  AT  IQ  RO  TA
        Add(282, "MIN", "Anthony",  "Edwards",          "SG", 25, "USA", 193, 102, 95, 97, 95, 97, 92, 94, 94, 90, 91, 98, 91, 98, 90, 58000000, 5, false);
        ...
        Add(297, "NOP", "Jordan",   "Poole",            "SG", 27, "USA", 193,  88, 78, 84, 89, 89, 89, 69, 84, 64, 69, 89, 74, 90, 65, 25000000, 3, false);
        ...
        Add(304, "NOP", "DeAndre",  "Jordan",           "C",  38, "USA", 211, 120, 60, 70, 74, 49, 54, 54, 79, 79, 69, 74, 49, 60, 70,  3000000, 1, false);
        ...
        // ── NYK ── 17 jugadores
        // ----------------------------------------------------------------------- OV  PO  VE  2P  3P  PA  DR  DF  RB  AT  IQ  RO  TA
        Add(311, "NYK", "Jalen",        "Brunson",      "PG", 29, "USA", 188,  86, 95, 96, 95, 96, 92, 95, 95, 95, 94, 97, 94, 95, 95, 48000000, 4, false);
        Add(312, "NYK", "Karl-Anthony", "Towns",        "C",  30, "USA", 213, 112, 90, 92, 91, 93, 90, 91, 90, 89, 94, 91, 91, 90, 90, 52000000, 4, false);
        Add(313, "NYK", "Mikal",        "Bridges",      "SF", 30, "USA", 198,  95, 88, 89, 88, 89, 87, 87, 88, 91, 87, 89, 90, 87, 86, 30000000, 4, false);
        Add(314, "NYK", "OG",           "Anunoby",      "SF", 29, "GBR", 201, 105, 88, 89, 88, 89, 86, 86, 87, 95, 87, 89, 90, 92, 87, 28000000, 4, false);
        Add(315, "NYK", "Josh",         "Hart",         "SG", 31, "USA", 196,  97, 84, 86, 81, 84, 80, 82, 84, 87, 93, 86, 85, 90, 72, 18000000, 3, false);
        Add(316, "NYK", "Miles",        "McBride",      "PG", 26, "USA", 185,  88, 83, 80, 88, 84, 86, 85, 84, 72, 84, 84, 87, 84, 71, 10000000, 3, false);
        Add(317, "NYK", "Andre",        "Drummond",     "C",  32, "USA", 211, 127, 72, 76, 60, 78, 58, 58, 57, 72, 97, 80, 78, 68, 86,  3900000, 1, false);
        Add(318, "NYK", "Jordan",       "Clarkson",     "SG", 33, "USA", 193,  88, 79, 80, 82, 84, 81, 85, 86, 73, 73, 79, 80, 74, 72,  3900000, 1, false);
        Add(319, "NYK", "Tyler",        "Kolek",        "PG", 25, "USA", 188,  84, 77, 79, 84, 78, 82, 84, 85, 70, 62, 76, 81, 83, 62,  4000000, 3, false);
        Add(498, "NYK", "Moussa",       "Cisse",        "C",  23, "MLI", 211, 102, 72, 79, 72, 76, 58, 58, 56, 78, 86, 82, 75, 62, 89,  2000000, 2, false);
        Add(320, "NYK", "Landry",       "Shamet",       "SG", 29, "USA", 193,  88, 76, 79, 79, 78, 85, 77, 84, 70, 65, 76, 78, 79, 65,  6000000, 1, false);
        Add(321, "NYK", "Jeremy",       "Sochan",       "PF", 23, "USA", 203, 104, 79, 79, 82, 81, 78, 80, 80, 85, 82, 82, 80, 79, 80,  9000000, 3, false);
        Add(322, "NYK", "Pacome",       "Dadiet",       "SF", 20, "FRA", 203,  93, 76, 78, 76, 77, 75, 76, 76, 76, 76, 76, 76, 75, 75,  3000000, 4, false);
        Add(323, "NYK", "Kevin",        "McCullar Jr.", "SF", 25, "USA", 198,  97, 77, 80, 77, 77, 77, 77, 77, 79, 76, 78, 77, 76, 76,  2500000, 3, false);
        Add(324, "NYK", "Ariel",        "Hukporti",     "C",  23, "DEU", 213, 110, 70, 79, 65, 76, 60, 59, 59, 74, 83, 78, 71, 59, 86,  2200000, 3, false);
        ...
        // ── OKC ── 14 jugadores
        // ------------------------------------------------------------------------- OV  PO  VE  2P  3P  PA  DR  DF  RB  AT  IQ  RO  TA 
        Add(327, "OKC", "Shai",     "Gilgeous-Alexander", "PG", 27, "CAN", 198,  88, 98, 99, 99, 99, 99, 99, 99, 99, 99, 99, 99, 91, 80, 62000000, 5, false);
        Add(328, "OKC", "Jalen",    "Williams",           "SF", 25, "USA", 198,  95, 89, 92, 96, 84, 91, 94, 96, 84, 91, 96, 94, 79, 68, 38000000, 4, false);
        Add(329, "OKC", "Chet",     "Holmgren",           "C",  24, "USA", 216,  97, 90, 92, 85, 89, 87, 79, 80, 99, 86, 97, 87, 99, 95, 36000000, 4, false);
        Add(330, "OKC", "Isaiah",   "Hartenstein",        "C",  28, "DEU", 213, 113, 87, 88, 89, 64, 99, 79, 94, 99, 89, 94, 87, 84, 76, 18000000, 3, false);
        Add(332, "OKC", "Alex",     "Caruso",             "SG", 32, "USA", 196,  92, 86, 87, 79, 94, 89, 89, 90, 84, 71, 85, 96, 62, 64, 14000000, 2, false);
        Add(333, "OKC", "Cason",    "Wallace",            "PG", 22, "USA", 191,  88, 85, 86, 79, 84, 87, 87, 91, 81, 89, 89, 91, 68, 88,  9000000, 4, false);
        Add(334, "OKC", "Kenrich",  "Williams",           "PF", 30, "USA", 198,  99, 83, 79, 74, 74, 84, 74, 94, 99, 74, 94, 87, 80, 77,  7000000, 2, false);
        Add(335, "OKC", "Jaylin",   "Williams",           "C",  23, "USA", 206, 108, 83, 79, 79, 84, 89, 74, 84, 99, 79, 89, 82, 80, 72,  6000000, 3, false);
        ...
        // ── PHI ── 16 jugadores
        // ------------------------------------------------------------------------- OV  PO  VE  2P  3P  PA  DR  DF  RB  AT  IQ  RO  TA
        Add(480, "PHI", "LeBron",     "James",            "SF", 42, "USA", 206, 113, 90, 90, 82, 94, 88, 96, 91, 87, 84, 94, 95, 94, 85,  4000000, 2, false);
        ...
        Add(358, "PHI", "Jaylen",     "Brown",            "SG", 29, "USA", 198, 101, 91, 95, 90, 94, 87, 91, 92, 91, 88, 96, 93, 91, 88, 53100000, 4, false);
        ...
        Add(361, "PHI", "Kyle",       "Lowry",            "PG", 40, "USA", 183,  88, 81, 78, 86, 84, 82, 72, 78, 80, 92, 82, 75, 75, 85,  8000000, 1, false);
        ...
        Add(366, "PHI", "Trendon",    "Watford",          "PF", 25, "USA", 203, 104, 77, 83, 82, 71, 80, 78, 80, 76, 72, 78, 80, 81, 69,  4000000, 2, false);
        ...
        // ── PHX ── 15 jugadores
        // ----------------------------------------------------------------------- OV  PO  VE  2P  3P  PA  DR  DF  RB  AT  IQ  RO  TA
        Add(372, "PHX", "Devin",    "Booker",           "SG", 29, "USA", 198,  96, 95, 95, 99, 99, 99, 99, 84, 89, 99, 99, 99, 84, 54, 60000000, 5, false);
        ...
        Add(375, "PHX", "Dillon",   "Brooks",           "SF", 30, "CAN", 198, 102, 78, 85, 84, 84, 69, 74, 94, 79, 69, 79, 63, 74, 55, 20000000, 3, false);
        ...
        // ── POR ── 12 jugadores
        // ----------------------------------------------------------------------- OV  PO  VE  2P  3P  PA  DR  DF  RB  AT  IQ  RO  TA
        Add(386, "PRT", "Ja",        "Morant",          "PG", 27, "USA", 188,  79, 85, 92, 94, 74, 91, 91, 79, 69, 94, 84, 84, 79, 65, 44000000, 4, false);
        ...
        Add(390, "PRT", "Jrue",      "Holiday",         "PG", 35, "USA", 193,  95, 80, 80, 84, 84, 89, 84, 96, 79, 79, 96, 91, 24, 86, 25000000, 2, false);
        ...
        Add(394, "PRT", "Robert",    "Williams III",    "C",  28, "USA", 208, 108, 74, 79, 79, 54, 84, 64, 89, 91, 79, 84, 49, 72, 58, 14600000, 3, false);
        ...
        Add(399, "SAC", "Zach",     "LaVine",           "SG", 31, "USA", 196,  91, 80, 84, 84, 89, 79, 84, 69, 69, 84, 79, 74, 80, 52, 40000000, 4, false);
        ...
        // ── SAS ── 17 jugadores
        // ----------------------------------------------------------------------- OV  PO  VE  2P  3P  PA  DR  DF  RB  AT  IQ  RO  TA
        Add(416, "SAS", "Victor",    "Wembanyama",      "C",  22, "FRA", 224, 104, 97, 99, 99, 99, 95, 89, 99, 99, 99, 99, 99, 99, 99, 60000000, 5, false);
        Add(417, "SAS", "De'Aaron",  "Fox",             "PG", 28, "USA", 191,  84, 89, 88, 96, 91, 94, 97, 99, 60, 59, 99, 99, 84, 48, 45000000, 5, false);
        Add(418, "SAS", "Stephon",   "Castle",          "SG", 21, "USA", 198,  96, 90, 96, 91, 84, 89, 91, 99, 87, 91, 94, 94, 79, 60,  9000000, 4, false);
        Add(419, "SAS", "Dylan",     "Harper",          "SG", 20, "USA", 196,  92, 86, 97, 89, 84, 87, 87, 89, 87, 87, 89, 84, 79, 45,  7000000, 4, false);
        Add(420, "SAS", "Devin",     "Vassell",         "SG", 27, "USA", 198,  94, 89, 89, 84, 94, 89, 89, 94, 94, 89, 91, 89, 79, 54, 22000000, 4, false);
        Add(421, "SAS", "Tobias",    "Harris",          "PF", 34, "USA", 203, 102, 82, 82, 89, 84, 84, 84, 79, 84, 74, 91, 79, 80, 60, 15500000, 2, false);
        Add(422, "SAS", "Keldon",    "Johnson",         "SF", 26, "USA", 198, 100, 83, 84, 89, 84, 74, 84, 79, 84, 89, 84, 81, 81, 54, 18000000, 3, false);
        Add(423, "SAS", "Carter",    "Bryant",          "SF", 20, "USA", 206,  96, 80, 89, 79, 79, 69, 74, 84, 84, 91, 79, 76, 76, 62,  5000000, 4, false);
        Add(424, "SAS", "Julian",    "Champagnie",      "SF", 26, "USA", 203,  98, 82, 82, 84, 94, 74, 79, 84, 84, 84, 84, 81, 70, 58,  6000000, 2, false);
        Add(425, "SAS", "Luke",      "Kornet",          "C",  30, "USA", 216, 113, 82, 78, 84, 69, 89, 74, 91, 91, 84, 89, 79, 83, 85,  5000000, 2, false);
        Add(426, "SAS", "Mason",     "Plumlee",         "C",  36, "USA", 211, 115, 78, 78, 84, 59, 89, 74, 84, 89, 69, 89, 79, 78, 83,  4000000, 1, false);
        Add(427, "SAS", "Kelly",     "Olynyk",          "PF", 35, "CAN", 211, 108, 81, 77, 84, 91, 89, 79, 84, 84, 74, 89, 74, 79, 56, 12000000, 2, false);
        Add(428, "SAS", "Bismack",   "Biyombo",         "C",  33, "COD", 206, 116, 77, 75, 74, 54, 64, 64, 94, 91, 84, 84, 79, 90, 92,  5000000, 1, false);
        Add(429, "SAS", "Harrison",  "Ingram",          "SF", 24, "USA", 201,  95, 79, 80, 79, 84, 69, 74, 79, 79, 79, 79, 84, 84, 54,  2500000, 3, false);
        ...
        // ── TOR ── 15 jugadores
        // ----------------------------------------------------------------------- OV  PO  VE  2P  3P  PA  DR  DF  RB  AT  IQ  RO  TA
        Add(433, "TOR", "Kawhi",      "Leonard",        "SF", 35, "USA", 201, 102, 87, 92, 84, 86, 85, 84, 86, 98, 82, 88, 90, 96, 84, 50000000, 2, false);
        ...
        // ── UTA ── 17 jugadores
        // ----------------------------------------------------------------------- OV  PO  VE  2P  3P  PA  DR  DF  RB  AT  IQ  RO  TA
        Add(448, "UTA", "Lauri",      "Markkanen",      "PF", 29, "FIN", 213, 109, 85, 92, 89, 99, 99, 99, 84, 99, 89, 89, 79, 75, 84, 42000000, 4, false);
        ...
        Add(459, "UTA", "Kevin",      "Love",           "PF", 37, "USA", 203, 113, 74, 74, 79, 84, 84, 74, 74, 84, 64, 84, 69, 54, 45,  8000000, 1, false);
        ...
        Add(466, "WAS", "Anthony",     "Davis",         "PF", 33, "USA", 208, 115, 90, 90, 76, 74, 89, 79, 99, 99, 89, 99, 93, 79, 82, 50000000, 4, false);
        ...
        Add(469, "WAS", "Cam",         "Whitmore",      "SF", 22, "USA", 198, 100, 77, 82, 91, 79, 69, 79, 74, 71, 91, 64, 64, 81, 74,  8000000, 4, false);
    ...
    public void SeedFreeAgents()
    {
        ...
        // ----------------------------------------------------------------------- OV  PO  VE  2P  3P  PA  DR  DF  RB  AT  IQ  RO  TA
        AddFA(404, "Russell",       "Westbrook",        "PG", 37, "USA", 191, 91,  82, 77, 79, 73, 79, 90, 89, 75, 79, 63, 64, 87, 26,  8000000, 1);
        AddFA(400, "DeMar",         "DeRozan",          "SF", 36, "USA", 201, 100, 86, 85, 79, 79, 88, 82, 78, 52, 69, 86, 89, 79, 35, 10000000, 2);
        AddFA(201, "Bradley",       "Beal",             "SG", 33, "USA", 193, 94,  85, 81, 67, 79, 76, 85, 79, 50, 64, 74, 79, 76, 36,  5500000, 2);
