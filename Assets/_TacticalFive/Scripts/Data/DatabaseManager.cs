...
public class DatabaseManager : MonoBehaviour
{
    ...
    void SeedPlayers()
    {
        ...
        Add(16, "BOS", "Paul", "George", "SF", 36, "USA", 206, 100, 80, 80, 90, 90, 90, 80, 90, 90, 73, 90, 90, 90, 31, 35000000, 2, false);
        Add(17, "BOS", "Derrick", "White", "PG", 32, "USA", 193, 86, 87, 86, 94, 90, 86, 92, 92, 98, 80, 92, 98, 90, 55, 28100000, 3, false);
        Add(18, "BOS", "Payton", "Pritchard", "PG", 28, "USA", 185, 88, 84, 85, 99, 96, 96, 90, 96, 82, 82, 82, 96, 86, 39, 7200000, 3, false);
        Add(19, "BOS", "Sam", "Hauser", "SF", 28, "USA", 201, 98, 80, 80, 88, 96, 98, 79, 83, 81, 69, 81, 87, 75, 43, 10000000, 4, false);
        Add(20, "BOS", "Neemias", "Queta", "C", 27, "PRT", 213, 111, 75, 78, 83, 71, 77, 75, 79, 81, 95, 89, 81, 65, 89, 11000000, 4, false);
        Add(21, "BOS", "Mike", "Conley", "PG", 38, "USA", 185, 79, 80, 80, 84, 90, 91, 98, 97, 76, 72, 82, 95, 90, 25, 10000000, 1, false);
        Add(22, "BOS", "Mitchell", "Robinson", "C", 28, "USA", 213, 111, 83, 83, 89, 79, 38, 71, 68, 99, 99, 99, 99, 73, 99, 14000000, 3, false);
        Add(23, "BOS", "Jordan", "Walsh", "SF", 22, "USA", 201, 93, 74, 81, 89, 71, 73, 69, 71, 87, 71, 91, 77, 75, 50, 2200000, 2, false);
        Add(24, "BOS", "Baylor", "Scheierman", "SG", 25, "USA", 198, 92, 75, 82, 86, 84, 90, 78, 80, 75, 67, 77, 82, 69, 37, 2600000, 2, false);
        Add(26, "BOS", "Hugo", "Gonzalez", "SF", 20, "ESP", 198, 91, 72, 84, 86, 74, 78, 78, 74, 78, 86, 86, 76, 74, 42, 2200000, 4, false);
        ...
        // ── CHI ── 15 jugadores
        Add(72, "CHI", "Josh", "Giddey", "PG", 23, "AUS", 203, 93, 86, 90, 89, 87, 91, 90, 90, 85, 89, 93, 90, 75, 43, 30000000, 5, false);
        ...
        // ── CLE ── 12 jugadores
        Add(87, "CLE", "Donovan", "Mitchell", "SG", 30, "USA", 191, 97, 93, 93, 90, 90, 90, 90, 90, 90, 81, 90, 90, 90, 51, 68000000, 4, false);
        ...
        // ── DAL ── 15 jugadores
        Add(100, "DAL", "Kyrie", "Irving", "PG", 34, "USA", 188, 88, 90, 90, 90, 90, 90, 90, 90, 86, 70, 90, 90, 95, 46, 36500000, 2, false);
        ...
        Add(123, "DEN", "Marvin", "Bagley III", "PF", 27, "USA", 208, 106, 76, 76, 89, 87, 76, 72, 74, 85, 95, 91, 83, 56, 48, 4000000, 1, false);
        Add(124, "DEN", "Tyus", "Jones", "PG", 30, "USA", 185, 89, 81, 81, 90, 88, 82, 99, 98, 77, 61, 82, 99, 88, 27, 8000000, 1, false);
        Add(126, "DEN", "Bruce", "Brown", "SG", 30, "USA", 193, 92, 79, 79, 91, 81, 85, 83, 85, 89, 68, 91, 85, 83, 38, 6000000, 1, false);
        Add(127, "DEN", "Peyton", "Watson", "SF", 23, "USA", 201, 91, 79, 88, 87, 75, 80, 72, 77, 89, 73, 93, 79, 77, 77, 5500000, 3, false);
        ...
        Add(130, "DEN", "Jalen", "Pickett", "PG", 27, "USA", 188, 83, 76, 76, 82, 82, 78, 96, 92, 75, 59, 78, 94, 73, 67, 2500000, 2, false);
        ...
        Add(136, "DET", "Jalen", "Duren", "C", 22, "USA", 211, 113, 85, 92, 93, 89, 64, 87, 83, 97, 99, 99, 95, 82, 97, 13000000, 3, false);
        Add(137, "DET", "John", "Collins", "PF", 29, "USA", 206, 103, 84, 84, 92, 94, 83, 79, 87, 87, 93, 98, 91, 69, 61, 17000000, 3, false);
        Add(138, "DET", "Ausar", "Thompson", "SF", 23, "USA", 201, 98, 84, 92, 93, 78, 66, 82, 85, 97, 80, 99, 87, 95, 62, 10000000, 3, false);
        Add(139, "DET", "Ebuka", "Okorie", "PG", 20, "NGA", 185, 84, 65, 78, 90, 78, 72, 82, 84, 76, 52, 88, 78, 80, 58, 4400000, 4, true);
        Add(140, "DET", "Isaiah", "Joe", "SG", 27, "USA", 193, 88, 80, 80, 92, 98, 99, 86, 92, 76, 60, 82, 94, 74, 57, 8000000, 2, false);
        Add(142, "DET", "Kevin", "Huerter", "SG", 28, "USA", 201, 91, 79, 79, 91, 91, 95, 82, 87, 78, 68, 84, 89, 70, 64, 17000000, 2, false);
        Add(143, "DET", "Duncan", "Robinson", "SG", 32, "USA", 201, 97, 88, 88, 89, 97, 99, 77, 83, 85, 66, 83, 89, 66, 64, 9000000, 2, false);
        Add(276, "DET", "Gary", "Harris", "SG", 32, "USA", 193, 95, 73, 73, 83, 77, 81, 73, 77, 83, 59, 81, 83, 79, 27, 3000000, 1, false);
        Add(271, "DET", "Taurean", "Prince", "SF", 32, "USA", 198, 99, 77, 77, 83, 84, 90, 75, 79, 85, 69, 83, 85, 79, 66, 6000000, 1, false);
        Add(144, "DET", "Ronald", "Holland II", "SF", 20, "USA", 203, 93, 77, 92, 90, 74, 64, 72, 78, 88, 74, 95, 78, 84, 50, 9000000, 4, false);
        Add(145, "DET", "Marcus", "Sasser", "PG", 25, "USA", 188, 84, 77, 80, 95, 89, 87, 89, 91, 71, 56, 85, 87, 71, 66, 4200000, 2, false);
        Add(146, "DET", "Javonte", "Green", "SF", 33, "USA", 193, 93, 75, 75, 86, 74, 79, 67, 72, 90, 68, 94, 78, 86, 61, 3900000, 1, false);
        Add(147, "DET", "Paul", "Reed", "PF", 27, "USA", 206, 95, 75, 78, 82, 74, 73, 78, 66, 88, 92, 90, 78, 70, 64, 5000000, 2, false);
        ...
        Add(150, "DET", "Ugonna", "Onyenso", "C", 21, "NGA", 213, 107, 57, 70, 70, 54, 56, 58, 58, 76, 94, 78, 70, 60, 92, 2000000, 2, true);
        ...
        // ── IND ── 17 jugadores
        Add(182, "IND", "Tyrese", "Haliburton", "PG", 26, "USA", 196, 84, 93, 95, 89, 89, 89, 89, 89, 89, 83, 89, 89, 89, 49, 55000000, 5, false);
        ...
        // ── LAC ── 15 jugadores   
        Add(198, "LAC", "Darius", "Garland", "PG", 26, "USA", 185, 87, 89, 91, 89, 89, 89, 89, 89, 86, 70, 89, 99, 92, 38, 40000000, 4, false);
        Add(199, "LAC", "Brandon", "Ingram", "SF", 28, "USA", 206, 98, 88, 90, 99, 99, 99, 92, 96, 86, 88, 98, 99, 88, 44, 38000000, 4, false);
        Add(200, "LAC", "Gradey", "Dick", "SG", 23, "USA", 198, 90, 82, 86, 96, 99, 99, 86, 92, 78, 60, 88, 96, 76, 72, 8000000, 4, false);
        ...
        Add(212, "LAC", "Baba", "Miller", "SF", 22, "ESP", 203, 100, 59, 71, 80, 76, 72, 68, 70, 80, 74, 82, 72, 70, 60, 2000000, 2, true);
        ...
        Add(263, "MIL", "Tyler", "Herro", "SG", 26, "USA", 196, 88, 87, 89, 88, 88, 88, 88, 88, 83, 70, 97, 88, 79, 34, 33000000, 4, false);
        ...
        Add(269, "MIL", "Gary", "Trent Jr.", "SG", 27, "USA", 196, 94, 80, 80, 92, 92, 94, 79, 86, 81, 65, 86, 88, 84, 33, 16000000, 4, false);
        ...
        // ── MIN ── 13 jugadores
        Add(282, "MIN", "Anthony", "Edwards", "SG", 25, "USA", 193, 102, 95, 97, 90, 90, 90, 90, 90, 90, 90, 90, 90, 90, 66, 58000000, 5, false);
        Add(283, "MIN", "LaMelo", "Ball", "PG", 25, "USA", 201, 82, 89, 92, 91, 91, 91, 91, 91, 85, 70, 91, 91, 89, 42, 37900000, 4, false);
        ...
        // ── NOP ── 15 jugadores
        Add(295, "NOP", "Zion", "Williamson", "PF", 26, "USA", 201, 129, 85, 90, 83, 83, 89, 98, 83, 83, 83, 83, 83, 88, 77, 60000000, 4, false);
        Add(296, "NOP", "Dejounte", "Murray", "PG", 30, "USA", 193, 83, 85, 86, 85, 89, 81, 85, 95, 91, 68, 91, 95, 85, 34, 28000000, 3, false);
        Add(297, "NOP", "Jordan", "Poole", "SG", 27, "USA", 193, 88, 82, 88, 83, 83, 97, 80, 95, 73, 55, 85, 85, 75, 34, 25000000, 3, false);
        ...
        Add(300, "NOP", "Saddiq", "Bey", "SF", 27, "USA", 203, 102, 81, 81, 89, 80, 92, 81, 87, 83, 73, 80, 80, 79, 37, 12000000, 2, false);
        ...
        Add(305, "NOP", "Jordan", "Hawkins", "SG", 23, "USA", 193, 88, 78, 86, 80, 88, 99, 78, 86, 70, 56, 86, 88, 70, 31, 4000000, 3, false);
        Add(306, "NOP", "Trey", "Alexander", "SG", 23, "USA", 193, 86, 76, 84, 80, 80, 88, 83, 86, 73, 55, 86, 85, 71, 25, 2500000, 4, false);
        Add(307, "NOP", "Bryce", "McGowens", "SG", 24, "USA", 198, 90, 75, 84, 80, 80, 83, 79, 83, 72, 56, 85, 83, 70, 28, 2000000, 3, false);
        Add(308, "NOP", "Jeremiah", "Fears", "PG", 20, "USA", 188, 82, 78, 92, 80, 80, 88, 84, 82, 68, 55, 88, 80, 72, 26, 5000000, 4, false);
        ...
        // ── PHI ── 16 jugadores
        Add(356, "PHI", "Joel", "Embiid", "C", 32, "CMR", 213, 127, 92, 93, 90, 90, 98, 90, 90, 90, 90, 90, 90, 79, 87, 65000000, 5, false);
        Add(357, "PHI", "Tyrese", "Maxey", "PG", 26, "USA", 188, 86, 92, 94, 90, 90, 90, 90, 90, 94, 74, 90, 90, 90, 52, 42000000, 5, false);
        Add(358, "PHI", "Jaylen", "Brown", "SG", 29, "USA", 198, 101, 90, 91, 90, 90, 94, 90, 98, 90, 89, 90, 90, 89, 57, 53100000, 4, false);
        Add(359, "PHI", "Dean", "Wade", "PF", 30, "USA", 206, 103, 76, 76, 78, 81, 85, 72, 74, 85, 77, 79, 83, 70, 52, 9750000, 4, false);
        Add(360, "PHI", "Anfernee", "Simons", "SG", 27, "USA", 191, 82, 86, 87, 90, 99, 99, 96, 99, 80, 62, 97, 99, 78, 38, 27000000, 2, false);
        ...
        Add(379, "PHX", "Khaman", "Maluach", "C", 20, "ZAF", 218, 110, 78, 92, 85, 79, 48, 84, 85, 93, 99, 91, 89, 58, 97, 6000000, 4, false);
        ...
        Add(382, "PHX", "Collin", "Gillespie", "PG", 27, "USA", 185, 84, 76, 80, 88, 86, 88, 94, 92, 88, 81, 80, 88, 76, 25, 3000000, 2, false);
        ...
        Add(389, "PRT", "Shaedon", "Sharpe", "SG", 23, "CAN", 198, 93, 90, 94, 89, 89, 89, 88, 89, 70, 75, 79, 79, 78, 45, 18000000, 4, false);
        Add(390, "PRT", "Jrue", "Holiday", "PG", 35, "USA", 193, 95, 84, 84, 91, 87, 81, 95, 95, 95, 69, 96, 95, 95, 25, 25000000, 2, false);
        Add(391, "PRT", "Deni", "Avdija", "SF", 26, "ISR", 206, 100, 84, 86, 92, 88, 82, 88, 80, 85, 80, 83, 82, 84, 30, 16000000, 3, false);
        ...
        Add(399, "SAC", "Zach", "LaVine", "SG", 31, "USA", 196, 91, 88, 90, 83, 83, 83, 98, 83, 83, 65, 83, 83, 85, 43, 40000000, 4, false);
        ...
        Add(418, "SAS", "Stephon", "Castle", "SG", 21, "USA", 198, 96, 94, 88, 96, 92, 94, 90, 92, 88, 79, 92, 92, 90, 39, 9000000, 4, false);
        ...
        Add(421, "SAS", "Tobias", "Harris", "PF", 34, "USA", 203, 102, 88, 80, 88, 89, 88, 84, 86, 84, 84, 88, 93, 68, 44, 15500000, 2, false);
        Add(422, "SAS", "Keldon", "Johnson", "SF", 26, "USA", 198, 100, 82, 84, 94, 94, 88, 84, 88, 86, 71, 90, 92, 84, 31, 18000000, 3, false);
        Add(423, "SAS", "Carter", "Bryant", "SF", 20, "USA", 206, 96, 78, 88, 84, 82, 80, 84, 86, 80, 80, 82, 80, 82, 68, 5000000, 4, false);
        Add(424, "SAS", "Julian", "Champagnie", "SF", 26, "USA", 203, 98, 78, 82, 87, 89, 91, 89, 83, 85, 65, 85, 85, 83, 26, 6000000, 2, false);
        Add(425, "SAS", "Luke", "Kornet", "C", 30, "USA", 216, 113, 78, 76, 72, 80, 57, 69, 81, 90, 94, 86, 88, 57, 94, 5000000, 2, false);
        Add(426, "SAS", "Mason", "Plumlee", "C", 36, "USA", 211, 115, 76, 74, 70, 74, 57, 87, 69, 88, 92, 84, 86, 57, 92, 4000000, 1, false);
        Add(427, "SAS", "Kelly", "Olynyk", "PF", 35, "CAN", 211, 108, 78, 78, 77, 88, 86, 83, 86, 81, 87, 81, 87, 75, 37, 12000000, 2, false);
        Add(428, "SAS", "Bismack", "Biyombo", "C", 33, "COD", 206, 116, 76, 72, 72, 70, 71, 81, 82, 98, 99, 96, 92, 57, 98, 5000000, 1, false);
        Add(429, "SAS", "Harrison", "Ingram", "SF", 24, "USA", 201, 95, 74, 82, 85, 79, 78, 76, 79, 83, 64, 83, 81, 81, 25, 2500000, 3, false);
        Add(430, "SAS", "Jayden", "Quaintance", "PF", 19, "USA", 206, 104, 65, 79, 82, 62, 74, 66, 68, 84, 90, 90, 74, 70, 82, 4100000, 4, true);
        Add(431, "SAS", "Tarris", "Reed Jr.", "C", 22, "USA", 206, 113, 64, 74, 72, 64, 74, 64, 60, 78, 92, 82, 78, 66, 82, 3600000, 4, true);
        ...
        // ── UTA ── 17 jugadores
        Add(448, "UTA", "Lauri", "Markkanen", "PF", 29, "FIN", 213, 109, 90, 92, 88, 88, 88, 94, 88, 92, 76, 97, 88, 90, 46, 42000000, 4, false);
    ...
    public void SeedFreeAgents()
    {
        ...
        AddFA(480, "LeBron", "James", "SF", 42, "USA", 206, 113, 89, 89, 92, 99, 91, 99, 99, 91, 93, 97, 99, 82, 48, 15000000, 1);
