...
public class ManagerController : MonoBehaviour
{
    ...
    void Refresh()
    {
        try { RefreshHeader(); } catch (System.Exception ex) { Debug.LogWarning($"[Manager] RefreshHeader error: {ex.Message}"); }
    }
    ...
    void RefreshHeader()
    {
        ...
        if (headerTeamLogo != null && logoDict.TryGetValue(_myTeam.logo, out var sprite))
            headerTeamLogo.style.backgroundImage = new StyleBackground(sprite.texture);
    }
